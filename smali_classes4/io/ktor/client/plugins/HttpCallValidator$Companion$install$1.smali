...
.method public constructor <init>(Lio/ktor/client/plugins/k;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, Lio/ktor/client/plugins/HttpCallValidator$Companion$install$1;->$plugin:Lio/ktor/client/plugins/k;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Lio/ktor/client/plugins/HttpCallValidator$Companion$install$1;->$plugin:Lio/ktor/client/plugins/k;

    invoke-direct {v0, p0, p3}, Lio/ktor/client/plugins/HttpCallValidator$Companion$install$1;-><init>(Lio/ktor/client/plugins/k;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-virtual {v0, p0}, Lio/ktor/client/plugins/HttpCallValidator$Companion$install$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object p0, p0, Lio/ktor/client/plugins/HttpCallValidator$Companion$install$1;->L$0:Ljava/lang/Object;
    ...
    iget-object v4, v4, Lio/ktor/client/request/a;->f:Lio/ktor/util/f;
    ...
    iget-object v7, p0, Lio/ktor/client/plugins/HttpCallValidator$Companion$install$1;->$plugin:Lio/ktor/client/plugins/k;

    invoke-direct {v6, v7}, Lio/ktor/client/plugins/HttpCallValidator$Companion$install$1$1;-><init>(Lio/ktor/client/plugins/k;)V

    invoke-virtual {v4, v5, v6}, Lio/ktor/util/f;->a(Lio/ktor/util/a;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Lio/ktor/client/plugins/HttpCallValidator$Companion$install$1;->$plugin:Lio/ktor/client/plugins/k;

    iget-object v1, v1, Lio/ktor/util/pipeline/e;->a:Ljava/lang/Object;

    check-cast v1, Lio/ktor/client/request/a;

    sget-object v4, Lio/ktor/client/plugins/m;->a:Lje/a;

    new-instance v4, Lio/ktor/client/plugins/l;

    invoke-direct {v4, v1}, Lio/ktor/client/plugins/l;-><init>(Lio/ktor/client/request/a;)V
    ...
    invoke-static {v3, p1, v4, p0}, Lio/ktor/client/plugins/k;->a(Lio/ktor/client/plugins/k;Ljava/lang/Throwable;LQa/b;Lkotlin/coroutines/jvm/internal/ContinuationImpl;)Lkotlin/Unit;
