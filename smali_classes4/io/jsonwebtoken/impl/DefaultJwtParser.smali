...
.method public parse(Ljava/lang/String;)Lio/jsonwebtoken/Jwt;
    ...
    .line 31
    iget-object v12, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->key:Ljava/security/Key;

    if-eqz v12, :cond_e

    iget-object v13, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->keyBytes:[B
    ...
    const-string v1, "A key object and key bytes cannot both be specified. Choose either."
    ...
    :cond_f
    iget-object v13, v0, Lio/jsonwebtoken/impl/DefaultJwtParser;->signingKeyResolver:Lio/jsonwebtoken/SigningKeyResolver;
    ...
    .line 47
    invoke-static {v6, v9}, Landroidx/camera/core/impl/n;->m(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 49
    invoke-virtual {v0, v4, v12}, Lio/jsonwebtoken/impl/DefaultJwtParser;->createSignatureValidator(Lio/jsonwebtoken/SignatureAlgorithm;Ljava/security/Key;)Lio/jsonwebtoken/impl/crypto/JwtSignatureValidator;

    move-result-object v4
    :try_end_0
    .catch Lio/jsonwebtoken/security/WeakKeyException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lio/jsonwebtoken/security/InvalidKeyException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0

    .line 50
    invoke-interface {v4, v6, v1}, Lio/jsonwebtoken/impl/crypto/JwtSignatureValidator;->isValid(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v3, " signature algorithm, but the specified signing key of type "

    .line 54
    invoke-static {v2, v1, v3}, Ld0/k;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    const-string v3, " may not be used to validate "
    ...
    .line 71
    invoke-static {v4, v1, v14, v2, v13}, Ld0/k;->u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    .line 73
    invoke-static {v4, v5, v10, v1}, Ld0/k;->h(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    .line 83
    invoke-static {v2, v1, v14, v4, v13}, Ld0/k;->u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    .line 91
    invoke-static {v7, v0}, Ld0/k;->f(ILjava/lang/String;)Ljava/lang/String;
...
.method public readValue(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-interface {p0, v0}, Lio/jsonwebtoken/io/Deserializer;->deserialize([B)Ljava/lang/Object;
    ...
    const-string v1, "Unable to read JSON value: "
