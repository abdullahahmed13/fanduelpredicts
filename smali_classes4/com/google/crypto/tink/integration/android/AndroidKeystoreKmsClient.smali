...
.method public static generateNewAeadKey(Ljava/lang/String;)V
    ...
    sget-object v2, Lcom/google/crypto/tink/integration/android/AndroidKeystoreKmsClient;->keyCreationLock:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    invoke-virtual {v1, p0}, Lcom/google/crypto/tink/integration/android/AndroidKeystoreKmsClient;->hasKey(Ljava/lang/String;)Z
    ...
    const-string p0, " because it already exists; please delete it with deleteKey() and try again"
...
.method public declared-synchronized getAead(Ljava/lang/String;)Lcom/google/crypto/tink/Aead;
    ...
    const-string v0, "this client is bound to "

    monitor-enter p0

    :try_start_0
    iget-object v1, p0, Lcom/google/crypto/tink/integration/android/AndroidKeystoreKmsClient;->keyUri:Ljava/lang/String;
    ...
    const-string v0, ", cannot load keys bound to "
