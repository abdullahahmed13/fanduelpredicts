...
.method public synthetic constructor <init>(Lcom/google/crypto/tink/jwt/JwtValidator$Builder;Lcom/google/crypto/tink/jwt/JwtValidator$1;)V
    .locals 0
...
.method public static synthetic access$1100()Ljava/time/Duration;
    .locals 1
...
.method private validateAudiences(Lcom/google/crypto/tink/jwt/RawJwt;)V
    ...
    iget-object p0, p0, Lcom/google/crypto/tink/jwt/JwtValidator;->expectedAudience:Ljava/util/Optional;
    ...
    invoke-direct {p1, p0}, Lcom/google/crypto/tink/jwt/JwtInvalidException;-><init>(Ljava/lang/String;)V
    ...
    iget-boolean p0, p0, Lcom/google/crypto/tink/jwt/JwtValidator;->ignoreAudiences:Z
    ...
    const-string p1, "invalid JWT; token has audience set, but validator not."
...
.method private validateIssuer(Lcom/google/crypto/tink/jwt/RawJwt;)V
    ...
    iget-object p0, p0, Lcom/google/crypto/tink/jwt/JwtValidator;->expectedIssuer:Ljava/util/Optional;
    ...
    iget-boolean p0, p0, Lcom/google/crypto/tink/jwt/JwtValidator;->ignoreIssuer:Z
    ...
    const-string p1, "invalid JWT; token has issuer set, but validator not."
...
.method private validateTimestampClaims(Lcom/google/crypto/tink/jwt/RawJwt;)V
    ...
    const-string p1, "token does not have an expiration set"
    ...
    const-string v1, "token has expired since "
    ...
    const-string v1, "token cannot be used before "
    ...
    invoke-virtual {v1, p0}, Ljava/time/Instant;->isAfter(Ljava/time/Instant;)Z
    ...
    const-string v1, "token has a invalid iat claim in the future: "
    ...
    const-string p1, "token does not have an iat claim"
...
.method private validateTypeHeader(Lcom/google/crypto/tink/jwt/RawJwt;)V
    ...
    iget-object p0, p0, Lcom/google/crypto/tink/jwt/JwtValidator;->expectedTypeHeader:Ljava/util/Optional;
    ...
    iget-boolean p0, p0, Lcom/google/crypto/tink/jwt/JwtValidator;->ignoreTypeHeader:Z
    ...
    const-string p1, "invalid JWT; token has type header set, but validator not."
...
.method public validate(Lcom/google/crypto/tink/jwt/RawJwt;)Lcom/google/crypto/tink/jwt/VerifiedJwt;
    .locals 0
    ...
    new-instance p0, Lcom/google/crypto/tink/jwt/VerifiedJwt;

    invoke-direct {p0, p1}, Lcom/google/crypto/tink/jwt/VerifiedJwt;-><init>(Lcom/google/crypto/tink/jwt/RawJwt;)V
