...
.method private constructor <init>(Lcom/google/crypto/tink/jwt/RawJwt$Builder;)V
    ...
    const-string p1, "neither setExpiration() nor withoutExpiration() was called"
    ...
    const-string p1, "setExpiration() and withoutExpiration() must not be called together"
...
.method private getInstant(Ljava/lang/String;)Ljava/time/Instant;
    ...
    :try_start_0
    iget-object p0, p0, Lcom/google/crypto/tink/jwt/RawJwt;->payload:Lcom/google/gson/JsonObject;
    ...
    const-string v0, " is not a timestamp"
...
.method private validateAudienceClaim()V
    ...
    const-string v0, "invalid JWT payload: claim aud is present but empty."
...
.method private validateStringClaim(Ljava/lang/String;)V
    ...
    const-string v0, "invalid JWT payload: claim "
...
.method private validateTimestampClaim(Ljava/lang/String;)V
    ...
    const-string v0, " has an invalid timestamp"
...
.method public customClaimNames()Ljava/util/Set;
    ...
    invoke-static {v1}, Lcom/google/crypto/tink/jwt/JwtNames;->isRegisteredName(Ljava/lang/String;)Z
...
.method public getAudiences()Ljava/util/List;
    ...
    const-string v1, "invalid audience: got %s; want a string"
    ...
    const-string v0, "claim aud is not a string or a JSON array"
    ...
    const-string v0, "claim aud does not exist"
...
.method public getJsonArrayClaim(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, " is not a JSON array"
...
.method public getJsonObjectClaim(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v0, " is not a JSON object"
...
.method public getTypeHeader()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/google/crypto/tink/jwt/RawJwt;->typeHeader:Ljava/util/Optional;
    ...
    const-string v0, "type header is not set"
...
.method public isNullClaim(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p0}, Lcom/google/gson/JsonNull;->equals(Ljava/lang/Object;)Z
