...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcd/b;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;

    return-void
.end method

.method public constructor <init>(Lcd/d;I)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcd/b;->f:Lcd/d;
    ...
    iput-object p1, p0, Lcd/b;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-direct {p1, p2}, Ljava/util/concurrent/atomic/AtomicReferenceArray;-><init>(I)V

    iput-object p1, p0, Lcd/b;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
# virtual methods
.method public final a(Ljava/lang/Object;Ljava/lang/Object;Lcd/g;)Ljava/lang/Object;
    .locals 9
    ...
    sget-object v4, Lcd/e;->a:LF1/p;

    sget-object v5, Lcd/b;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    new-instance p3, Lcd/g;

    iget-object v1, p0, Lcd/b;->f:Lcd/d;

    iget-object v1, v1, Lcd/d;->a:Ljava/lang/ref/ReferenceQueue;
    ...
    :cond_8
    :goto_1
    iget-object v3, p0, Lcd/b;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-virtual {v3, v0}, Ljava/util/concurrent/atomic/AtomicReferenceArray;->get(I)Ljava/lang/Object;

    move-result-object v5

    instance-of p1, v5, Lcd/h;
    ...
    invoke-virtual {p0, v0}, Lcd/b;->c(I)V
...
.method public final b()Lcd/b;
    ...
    :cond_0
    iget-object v0, p0, Lcd/b;->f:Lcd/d;

    invoke-virtual {v0}, Lcd/d;->c()I
    ...
    invoke-direct {v2, v0, v1}, Lcd/b;-><init>(Lcd/d;I)V
    ...
    iget-object v1, p0, Lcd/b;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    :cond_3
    :goto_2
    iget-object v4, p0, Lcd/b;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-virtual {v4, v0}, Ljava/util/concurrent/atomic/AtomicReferenceArray;->get(I)Ljava/lang/Object;

    move-result-object v5

    instance-of v6, v5, Lcd/h;

    if-eqz v6, :cond_4

    check-cast v5, Lcd/h;

    iget-object v5, v5, Lcd/h;->a:Ljava/lang/Object;
    ...
    invoke-direct {v6, v5}, Lcd/h;-><init>(Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v3, v5, v1}, Lcd/b;->a(Ljava/lang/Object;Ljava/lang/Object;Lcd/g;)Ljava/lang/Object;

    move-result-object v1

    sget-object v3, Lcd/e;->a:LF1/p;
...
.method public final c(I)V
    ...
    :goto_0
    iget-object v0, p0, Lcd/b;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    iget-object p0, p0, Lcd/b;->f:Lcd/d;
