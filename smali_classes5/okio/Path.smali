...
.method public final a()Ljava/util/ArrayList;
    ...
    invoke-static {p0}, Lokio/internal/c;->a(Lokio/Path;)I
    ...
    :cond_2
    invoke-virtual {p0, v4, v1}, Lokio/ByteString;->q(II)Lokio/ByteString;
...
.method public final b()Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Lokio/ByteString;->n(Lokio/ByteString;Lokio/ByteString;)I
    ...
    invoke-static {v1, v0, p0, v3}, Lokio/ByteString;->r(Lokio/ByteString;III)Lokio/ByteString;
...
.method public final c()Lokio/Path;
    ...
    invoke-virtual {v1, v6, v5, v7}, Lokio/ByteString;->o(ILokio/ByteString;I)Z
    ...
    invoke-virtual {v1, v5, v2, v8}, Lokio/ByteString;->o(ILokio/ByteString;I)Z
    ...
    invoke-virtual {v1, v5, v4, v8}, Lokio/ByteString;->o(ILokio/ByteString;I)Z
    ...
    :cond_2
    invoke-static {v1, v2}, Lokio/ByteString;->n(Lokio/ByteString;Lokio/ByteString;)I
    ...
    :cond_3
    invoke-static {v1, v4}, Lokio/ByteString;->n(Lokio/ByteString;Lokio/ByteString;)I
    ...
    invoke-static {v1, v9, v6, v8}, Lokio/ByteString;->r(Lokio/ByteString;III)Lokio/ByteString;

    move-result-object p0

    invoke-direct {v3, p0}, Lokio/Path;-><init>(Lokio/ByteString;)V
    ...
    invoke-virtual {v4}, Lokio/ByteString;->f()I

    move-result v6

    invoke-virtual {v1, v9, v4, v6}, Lokio/ByteString;->o(ILokio/ByteString;I)Z
    ...
    invoke-static {v1, v9, v7, v8}, Lokio/ByteString;->r(Lokio/ByteString;III)Lokio/ByteString;
    ...
    invoke-static {v1, v9, v8, v8}, Lokio/ByteString;->r(Lokio/ByteString;III)Lokio/ByteString;
    ...
    invoke-static {v1, v9, v2, v8}, Lokio/ByteString;->r(Lokio/ByteString;III)Lokio/ByteString;
...
.method public final d(Lokio/Path;)Lokio/Path;
    ...
    invoke-virtual {v1, v4, v0}, Lokio/ByteString;->q(II)Lokio/ByteString;
    ...
    invoke-virtual {v6, v4, v0}, Lokio/ByteString;->q(II)Lokio/ByteString;
    ...
    sget-object v7, Lokio/internal/c;->e:Lokio/ByteString;
    ...
    sget-object v1, Lokio/internal/c;->d:Lokio/ByteString;
    ...
    invoke-static {p0}, Lokio/internal/c;->f(Ljava/lang/String;)Lokio/ByteString;
    ...
    sget-object v3, Lokio/internal/c;->e:Lokio/ByteString;

    invoke-virtual {v1, v3}, Lokio/Buffer;->N0(Lokio/ByteString;)V

    invoke-virtual {v1, p1}, Lokio/Buffer;->N0(Lokio/ByteString;)V
    ...
    invoke-virtual {v1, v2}, Lokio/Buffer;->N0(Lokio/ByteString;)V
    ...
    :cond_7
    invoke-static {v1, v4}, Lokio/internal/c;->d(Lokio/Buffer;Z)Lokio/Path;
...
.method public final e(Ljava/lang/String;)Lokio/Path;
    ...
    invoke-static {p0, v0, p1}, Lokio/internal/c;->b(Lokio/Path;Lokio/Path;Z)Lokio/Path;
...
.method public final h()Ljava/lang/Character;
    ...
    invoke-static {p0, v0}, Lokio/ByteString;->j(Lokio/ByteString;Lokio/ByteString;)I
