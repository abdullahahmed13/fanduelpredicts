...
.method public constructor <init>(LJc/n;)V
    ...
    invoke-direct {p0, p1}, LKc/i;-><init>(LJc/n;)V
...
.method public final c()LKc/B;
    ...
    invoke-virtual {p0}, LKc/b;->o()LSb/e;
    ...
    sget-object v2, LPb/q;->a:Luc/h;

    invoke-static {v0, v2}, LPb/j;->b(LSb/e;Luc/h;)Z

    move-result v2

    if-nez v2, :cond_1

    sget-object v2, LPb/q;->b:Luc/h;
    ...
    :cond_0
    invoke-virtual {p0}, LKc/b;->e()LPb/j;
...
.method public final d(Z)Ljava/util/Collection;
    .locals 2
    ...
    invoke-virtual {v0, p0}, LUc/g;->add(Ljava/lang/Object;)Z
...
.method public bridge synthetic f()LSb/g;
    .locals 0
...
.method public final k(LSb/g;)Z
    ...
    instance-of v0, p0, LSb/y;

    if-eqz v0, :cond_2

    instance-of p0, p1, LSb/y;

    goto :goto_3

    :cond_2
    instance-of v0, p1, LSb/y;
...
.method public abstract o()LSb/e;
.end method
