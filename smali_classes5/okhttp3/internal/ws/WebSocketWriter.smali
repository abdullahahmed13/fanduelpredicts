...
.method public constructor <init>(ZLokio/BufferedSink;Ljava/util/Random;ZZJ)V
    ...
    invoke-interface {p2}, Lokio/BufferedSink;->f()Lokio/Buffer;
...
.method private final writeControlFrame(ILokio/ByteString;)V
    ...
    invoke-virtual {v1, p1}, Lokio/Buffer;->Q0(I)V
    ...
    invoke-virtual {p1, v1}, Lokio/Buffer;->O0([B)V
    ...
    invoke-virtual {p1, p2}, Lokio/Buffer;->N0(Lokio/ByteString;)V
    ...
    invoke-virtual {p1, p2}, Lokio/Buffer;->M(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;

    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/Buffer$UnsafeCursor;

    invoke-virtual {p1, v0, v1}, Lokio/Buffer$UnsafeCursor;->i(J)I
    ...
    invoke-virtual {p1, v0}, Lokio/Buffer;->Q0(I)V
...
.method public final writeClose(ILokio/ByteString;)V
    ...
    invoke-virtual {v0, p2}, Lokio/Buffer;->N0(Lokio/ByteString;)V

    :cond_2
    iget-wide p1, v0, Lokio/Buffer;->b:J

    invoke-virtual {v0, p1, p2}, Lokio/Buffer;->a0(J)Lokio/ByteString;
...
.method public final writeMessageFrame(ILokio/ByteString;)V
    ...
    invoke-virtual {v1, v0}, Lokio/Buffer;->Q0(I)V
    ...
    invoke-virtual {v0, v1}, Lokio/Buffer;->V0(I)V
    ...
    invoke-virtual {v0, p1, p2}, Lokio/Buffer;->U0(J)V
    ...
    invoke-virtual {v0, v1}, Lokio/Buffer;->O0([B)V
    ...
    invoke-virtual {v2, v3}, Lokio/Buffer;->M(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;

    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/Buffer$UnsafeCursor;

    invoke-virtual {v2, v0, v1}, Lokio/Buffer$UnsafeCursor;->i(J)I
    ...
    invoke-interface {p0}, Lokio/BufferedSink;->l()Lokio/BufferedSink;
