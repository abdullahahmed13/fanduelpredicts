...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lokio/Okio;->j(Ljava/net/Socket;)Lokio/Source;
    ...
    invoke-static {v1}, Lokio/Okio;->f(Ljava/net/Socket;)Lokio/Sink;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {v3}, Lokio/Okio;->j(Ljava/net/Socket;)Lokio/Source;
    ...
    invoke-static {v3}, Lokio/Okio;->f(Ljava/net/Socket;)Lokio/Sink;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-virtual {p0}, Lokio/Buffer;->h0()Z

    move-result p0

    if-eqz p0, :cond_4

    invoke-interface {v1}, Lokio/BufferedSink;->f()Lokio/Buffer;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {v3, v0, v4}, Landroidx/camera/core/impl/n;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
