...
.method public constructor <init>(Lokio/Source;)V
    ...
    .line 3
    invoke-virtual {v1, v2, v3}, Lokio/RealBufferedSource;->y(J)Ljava/lang/String;
    ...
    .line 36
    invoke-virtual {v1}, Lokio/RealBufferedSource;->h0()Z
...
.method private final readCertificateList(Lokio/BufferedSource;)Ljava/util/List;
    ...
    invoke-virtual {v4, v3}, Lokio/Buffer;->N0(Lokio/ByteString;)V

    new-instance v3, Lokio/Buffer$inputStream$1;

    invoke-direct {v3, v4}, Lokio/Buffer$inputStream$1;-><init>(Lokio/Buffer;)V
...
.method private final writeCertList(Lokio/BufferedSink;Ljava/util/List;)V
    ...
    invoke-interface {p1, v0, v1}, Lokio/BufferedSink;->W(J)Lokio/BufferedSink;
    ...
    invoke-static {v1, p2}, Lokio/ByteString$Companion;->d(Lokio/ByteString$Companion;[B)Lokio/ByteString;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v1}, Lokio/RealBufferedSink;->F(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, v2}, Lokio/RealBufferedSink;->F(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, v2, v3}, Lokio/RealBufferedSink;->W(J)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, v5}, Lokio/RealBufferedSink;->F(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-virtual {p1, p0}, Lokio/RealBufferedSink;->F(Ljava/lang/String;)Lokio/BufferedSink;
