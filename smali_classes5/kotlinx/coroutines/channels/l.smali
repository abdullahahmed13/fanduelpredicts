...
.method public constructor <init>(ILkotlinx/coroutines/channels/BufferOverflow;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {p0, p1, p3}, Lkotlinx/coroutines/channels/c;-><init>(ILkotlin/jvm/functions/Function1;)V

    iput-object p2, p0, Lkotlinx/coroutines/channels/l;->m:Lkotlinx/coroutines/channels/BufferOverflow;
    ...
    invoke-virtual {p1, p2}, Lkotlin/jvm/internal/r;->b(Ljava/lang/Class;)Lkotlin/reflect/KClass;
...
.method public final L(Ljava/lang/Object;Z)Ljava/lang/Object;
    ...
    iget-object v1, v8, Lkotlinx/coroutines/channels/l;->m:Lkotlinx/coroutines/channels/BufferOverflow;

    const/4 v9, 0x0

    if-ne v1, v0, :cond_3

    invoke-super/range {p0 .. p1}, Lkotlinx/coroutines/channels/c;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v8, Lkotlinx/coroutines/channels/c;->b:Lkotlin/jvm/functions/Function1;

    if-eqz v0, :cond_2

    move-object/from16 v10, p1

    invoke-static {v0, v10, v9}, Lkotlinx/coroutines/internal/b;->b(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;Lkotlinx/coroutines/internal/UndeliveredElementException;)Lkotlinx/coroutines/internal/UndeliveredElementException;
    ...
    :goto_2
    sget-object v1, Lkotlinx/coroutines/channels/c;->d:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    invoke-virtual {v8, v1, v2, v3}, Lkotlinx/coroutines/channels/c;->w(JZ)Z
    ...
    iget-wide v9, v0, Lkotlinx/coroutines/internal/w;->c:J

    cmp-long v3, v9, v1

    if-eqz v3, :cond_6

    invoke-static {v8, v1, v2, v0}, Lkotlinx/coroutines/channels/c;->b(Lkotlinx/coroutines/channels/c;JLkotlinx/coroutines/channels/ChannelSegment;)Lkotlinx/coroutines/channels/ChannelSegment;
    ...
    invoke-virtual {v9}, Lkotlinx/coroutines/internal/w;->i()V
    ...
    :cond_c
    instance-of v0, v11, Lkotlinx/coroutines/F0;
    ...
    invoke-interface {v0, v9, v4}, Lkotlinx/coroutines/F0;->a(Lkotlinx/coroutines/internal/w;I)V

    :cond_e
    iget-wide v0, v9, Lkotlinx/coroutines/internal/w;->c:J
    ...
    invoke-virtual {v8, v0, v1}, Lkotlinx/coroutines/channels/c;->o(J)V
...
.method public final c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, v0}, Lkotlinx/coroutines/channels/l;->L(Ljava/lang/Object;Z)Ljava/lang/Object;
...
.method public final l(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/channels/l;->L(Ljava/lang/Object;Z)Ljava/lang/Object;

    move-result-object p2

    instance-of v0, p2, Lkotlinx/coroutines/channels/g;

    if-eqz v0, :cond_1

    invoke-static {p2}, Lkotlinx/coroutines/channels/j;->a(Ljava/lang/Object;)Ljava/lang/Throwable;

    iget-object p2, p0, Lkotlinx/coroutines/channels/c;->b:Lkotlin/jvm/functions/Function1;
...
.method public final z()Z
    ...
    iget-object p0, p0, Lkotlinx/coroutines/channels/l;->m:Lkotlinx/coroutines/channels/BufferOverflow;
