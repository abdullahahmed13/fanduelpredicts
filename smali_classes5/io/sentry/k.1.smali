...
.method public constructor <init>(Lio/sentry/android/core/SentryAndroidOptions;)V
    ...
    iput-object v0, p0, Lio/sentry/k;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lio/sentry/k;->i:J
    ...
    iput-object p1, p0, Lio/sentry/k;->g:Lio/sentry/android/core/SentryAndroidOptions;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/sentry/k;->d:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/sentry/k;->e:Ljava/util/ArrayList;
    ...
    instance-of v2, v0, Lio/sentry/I;

    if-eqz v2, :cond_1

    iget-object v2, p0, Lio/sentry/k;->d:Ljava/util/ArrayList;

    move-object v3, v0

    check-cast v3, Lio/sentry/I;

    invoke-virtual {v2, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_1
    instance-of v2, v0, Lio/sentry/H;

    if-eqz v2, :cond_0

    iget-object v2, p0, Lio/sentry/k;->e:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object p1, p0, Lio/sentry/k;->d:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lio/sentry/k;->e:Ljava/util/ArrayList;
    ...
    :cond_3
    iput-boolean v1, p0, Lio/sentry/k;->f:Z
...
.method public final a(Lio/sentry/E1;)V
    ...
    iget-object p0, p0, Lio/sentry/k;->e:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, p1}, Lio/sentry/android/core/f0;->e(Lio/sentry/O;)V
...
.method public final close()V
    ...
    iget-object v0, p0, Lio/sentry/k;->g:Lio/sentry/android/core/SentryAndroidOptions;
    ...
    iget-object v0, p0, Lio/sentry/k;->e:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v0, p0, Lio/sentry/k;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final d(Lio/sentry/E1;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lio/sentry/android/core/f0;->f(Lio/sentry/O;)V
...
.method public final e(Lio/sentry/C1;)V
    ...
    iget-boolean v0, p0, Lio/sentry/k;->f:Z

    if-eqz v0, :cond_0

    iget-object p0, p0, Lio/sentry/k;->g:Lio/sentry/android/core/SentryAndroidOptions;
    ...
    invoke-virtual {v1, p1}, Lio/sentry/android/core/f0;->f(Lio/sentry/O;)V
    ...
    iget-object v1, p1, Lio/sentry/C1;->a:Lio/sentry/protocol/r;
    ...
    invoke-interface {v0, v1, v2, v3}, Lio/sentry/M;->o(Ljava/lang/Runnable;J)Ljava/util/concurrent/Future;
    :try_end_0
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Lio/sentry/k;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final f(Lio/sentry/P;)Ljava/util/List;
    .locals 4
    ...
    iget-object v3, v3, Lio/sentry/F1;->a:Lio/sentry/protocol/r;
    ...
    invoke-virtual {v3, p1}, Lio/sentry/android/core/f0;->e(Lio/sentry/O;)V
