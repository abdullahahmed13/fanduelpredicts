...
.method public constructor <init>(Lio/sentry/SentryOptions;Lio/sentry/D;)V
    ...
    iput-object p2, p0, Lio/sentry/PreviousSessionFinalizer;->hub:Lio/sentry/D;
...
.method private getTimestampFromCrashMarkerFile(Ljava/io/File;)Ljava/util/Date;
    ...
    invoke-static {p1}, Lzd/a;->z(Ljava/lang/String;)Ljava/util/Date;
...
.method public run()V
    ...
    invoke-virtual {v2}, Lio/sentry/SentryOptions;->getEnvelopeDiskCache()Lio/sentry/cache/d;

    move-result-object v2

    instance-of v3, v2, Lio/sentry/cache/c;

    if-eqz v3, :cond_2

    check-cast v2, Lio/sentry/cache/c;

    invoke-virtual {v2}, Lio/sentry/cache/c;->f()Z
    ...
    :try_start_1
    const-class v4, Lio/sentry/D1;

    invoke-interface {v0, v3, v4}, Lio/sentry/N;->d(Ljava/io/Reader;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-interface {v8, v9, v10, v5}, Lio/sentry/ILogger;->c(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v5, v7, v8, v7}, Lio/sentry/D1;->d(Lio/sentry/Session$State;Ljava/lang/String;ZLjava/lang/String;)Z
    ...
    :goto_0
    iget-object v5, v4, Lio/sentry/D1;->n:Ljava/lang/String;

    if-nez v5, :cond_6

    invoke-virtual {v4, v6}, Lio/sentry/D1;->b(Ljava/util/Date;)V

    :cond_6
    iget-object v5, p0, Lio/sentry/PreviousSessionFinalizer;->options:Lio/sentry/SentryOptions;

    invoke-virtual {v5}, Lio/sentry/SentryOptions;->getSdkVersion()Lio/sentry/protocol/p;

    move-result-object v5

    new-instance v6, Lio/sentry/Y0;

    invoke-static {v0, v4}, Lio/sentry/c1;->c(Lio/sentry/N;Lio/sentry/D1;)Lio/sentry/c1;

    move-result-object v0

    invoke-direct {v6, v7, v5, v0}, Lio/sentry/Y0;-><init>(Lio/sentry/protocol/r;Lio/sentry/protocol/p;Lio/sentry/c1;)V

    iget-object v0, p0, Lio/sentry/PreviousSessionFinalizer;->hub:Lio/sentry/D;

    invoke-interface {v0, v6}, Lio/sentry/D;->captureEnvelope(Lio/sentry/Y0;)Lio/sentry/protocol/r;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
