...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lio/sentry/D;Lio/sentry/android/core/SentryAndroidOptions;Lio/sentry/transport/d;)V
    .locals 0
    ...
    iput-object p2, p0, Lio/sentry/android/core/x;->b:Lio/sentry/D;
    ...
    iput-wide p1, p0, Lio/sentry/android/core/x;->d:J
...
.method public final a(Landroid/app/ApplicationExitInfo;Z)V
    ...
    iget-object v0, p0, Lio/sentry/android/core/x;->c:Lio/sentry/android/core/SentryAndroidOptions;
    ...
    :goto_0
    :try_start_0
    invoke-static {p1}, Landroidx/core/view/y0;->j(Landroid/app/ApplicationExitInfo;)Ljava/io/InputStream;
    ...
    invoke-direct {v2, v3}, Lio/sentry/android/core/z;-><init>(Lio/sentry/android/core/AnrV2Integration$ParseResult$Type;)V
    :try_end_1
    ...
    invoke-direct {v4, v2}, Landroidx/compose/animation/core/s0;-><init>(Ljava/util/ArrayList;)V

    new-instance v2, Lio/sentry/android/core/internal/threaddump/b;

    invoke-direct {v2, v0, v8}, Lio/sentry/android/core/internal/threaddump/b;-><init>(Lio/sentry/SentryOptions;Z)V

    invoke-virtual {v2, v4}, Lio/sentry/android/core/internal/threaddump/b;->d(Landroidx/compose/animation/core/s0;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v4}, Lio/sentry/android/core/z;-><init>(Lio/sentry/android/core/AnrV2Integration$ParseResult$Type;)V
    :try_end_8
    ...
    invoke-direct {v4, v5, v3, v2}, Lio/sentry/android/core/z;-><init>(Lio/sentry/android/core/AnrV2Integration$ParseResult$Type;[BLjava/util/ArrayList;)V
    :try_end_a
    ...
    invoke-interface {v2, v4, v5, v1}, Lio/sentry/ILogger;->b(Lio/sentry/SentryLevel;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v2, v1, v3}, Lio/sentry/android/core/z;-><init>(Lio/sentry/android/core/AnrV2Integration$ParseResult$Type;[B)V
    ...
    invoke-direct {v2, v1}, Lio/sentry/android/core/z;-><init>(Lio/sentry/android/core/AnrV2Integration$ParseResult$Type;)V
    ...
    iget-object v12, v11, Lio/sentry/android/core/z;->a:Lio/sentry/android/core/AnrV2Integration$ParseResult$Type;
    ...
    invoke-static {p1}, Lcom/google/android/material/color/a;->o(Landroid/app/ApplicationExitInfo;)Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v8}, Lio/sentry/android/core/y;-><init>(JLio/sentry/ILogger;JZZ)V
    ...
    invoke-direct {v1}, Lio/sentry/e1;-><init>()V
    ...
    iput-object v3, v2, Lio/sentry/protocol/i;->a:Ljava/lang/String;

    iput-object v2, v1, Lio/sentry/e1;->q:Lio/sentry/protocol/i;
    ...
    iget-object v2, v11, Lio/sentry/android/core/z;->c:Ljava/util/ArrayList;

    new-instance v3, Landroidx/compose/ui/graphics/vector/h;

    invoke-direct {v3, v2}, Landroidx/compose/ui/graphics/vector/h;-><init>(Ljava/util/List;)V

    iput-object v3, v1, Lio/sentry/e1;->s:Landroidx/compose/ui/graphics/vector/h;
    ...
    invoke-static {v9, v10}, Lzd/a;->y(J)Ljava/util/Date;

    move-result-object v2

    iput-object v2, v1, Lio/sentry/e1;->p:Ljava/util/Date;
    ...
    iget-object v2, v11, Lio/sentry/android/core/z;->b:[B

    if-eqz v2, :cond_a

    new-instance v3, Lio/sentry/a;

    invoke-direct {v3, v2}, Lio/sentry/a;-><init>([B)V

    iput-object v3, p2, Lio/sentry/v;->e:Lio/sentry/a;

    :cond_a
    iget-object p0, p0, Lio/sentry/android/core/x;->b:Lio/sentry/D;

    invoke-interface {p0, v1, p2}, Lio/sentry/D;->captureEvent(Lio/sentry/e1;Lio/sentry/v;)Lio/sentry/protocol/r;

    move-result-object p0

    sget-object p2, Lio/sentry/protocol/r;->b:Lio/sentry/protocol/r;

    invoke-virtual {p0, p2}, Lio/sentry/protocol/r;->equals(Ljava/lang/Object;)Z
    ...
    iget-object p2, v1, Lio/sentry/T0;->a:Lio/sentry/protocol/r;
...
.method public final run()V
    ...
    iget-object v3, p0, Lio/sentry/android/core/x;->c:Lio/sentry/android/core/SentryAndroidOptions;
    ...
    :cond_0
    invoke-virtual {v3}, Lio/sentry/SentryOptions;->getEnvelopeDiskCache()Lio/sentry/cache/d;
    ...
    invoke-static {v0, v4}, Lorg/slf4j/helpers/c;->N(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lio/sentry/util/b;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-interface {v5, v6, v7, v4}, Lio/sentry/ILogger;->c(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {v5, v6, v7, v4}, Lio/sentry/ILogger;->b(Lio/sentry/SentryLevel;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v6}, Lcom/google/android/material/color/a;->d(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, Lcom/google/android/material/color/a;->b(Landroid/app/ApplicationExitInfo;)I
    ...
    iget-wide v8, p0, Lio/sentry/android/core/x;->d:J
    ...
    invoke-interface {v6, v10, v11, v5}, Lio/sentry/ILogger;->c(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_b
    invoke-virtual {p0, v5, v2}, Lio/sentry/android/core/x;->a(Landroid/app/ApplicationExitInfo;Z)V
    ...
    invoke-virtual {p0, v0, v1}, Lio/sentry/android/core/x;->a(Landroid/app/ApplicationExitInfo;Z)V
