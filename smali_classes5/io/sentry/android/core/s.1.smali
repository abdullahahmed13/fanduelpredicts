...
.field public final g:Lio/sentry/android/core/internal/util/i;
...
.field public final l:Lio/sentry/android/core/E;

.field public final m:Lio/sentry/M;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;ILio/sentry/android/core/internal/util/i;Lio/sentry/M;Lio/sentry/ILogger;Lio/sentry/android/core/E;)V
    .locals 2
    ...
    iput-boolean v0, p0, Lio/sentry/android/core/s;->o:Z
    ...
    invoke-static {p5, p1}, Lorg/slf4j/helpers/c;->N(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object p5, p0, Lio/sentry/android/core/s;->n:Lio/sentry/ILogger;
    ...
    iput-object p4, p0, Lio/sentry/android/core/s;->m:Lio/sentry/M;
    ...
    iput-object p3, p0, Lio/sentry/android/core/s;->g:Lio/sentry/android/core/internal/util/i;

    const-string p1, "The BuildInfoProvider is required."

    invoke-static {p6, p1}, Lorg/slf4j/helpers/c;->N(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object p6, p0, Lio/sentry/android/core/s;->l:Lio/sentry/android/core/E;
...
.method public final declared-synchronized a(Ljava/util/List;Z)Lio/sentry/android/core/q;
    ...
    iget-object p1, p0, Lio/sentry/android/core/s;->n:Lio/sentry/ILogger;
    ...
    invoke-interface {p1, p2, v0, v2}, Lio/sentry/ILogger;->c(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lio/sentry/android/core/s;->l:Lio/sentry/android/core/E;
    ...
    :goto_0
    :try_start_3
    iput-boolean v2, p0, Lio/sentry/android/core/s;->o:Z
    :try_end_3
    ...
    :try_start_4
    iget-object v3, p0, Lio/sentry/android/core/s;->n:Lio/sentry/ILogger;
    ...
    :goto_1
    :try_start_5
    iget-object v0, p0, Lio/sentry/android/core/s;->g:Lio/sentry/android/core/internal/util/i;

    iget-object v3, p0, Lio/sentry/android/core/s;->f:Ljava/lang/String;

    invoke-virtual {v0, v3}, Lio/sentry/android/core/internal/util/i;->a(Ljava/lang/String;)V
    ...
    iget-object v9, p0, Lio/sentry/android/core/s;->i:Ljava/util/ArrayDeque;
    ...
    iget-object v9, p0, Lio/sentry/android/core/s;->j:Ljava/util/ArrayDeque;
    ...
    iget-object v9, p0, Lio/sentry/android/core/s;->h:Ljava/util/ArrayDeque;
    ...
    iput-object v1, p0, Lio/sentry/android/core/s;->d:Ljava/util/concurrent/Future;

    :cond_5
    new-instance p1, Lio/sentry/android/core/q;

    iget-object v10, p0, Lio/sentry/android/core/s;->e:Ljava/io/File;

    iget-object v11, p0, Lio/sentry/android/core/s;->k:Ljava/util/HashMap;
...
.method public final b(Ljava/util/List;)V
    ...
    check-cast v6, Lio/sentry/x0;

    iget-object v7, v6, Lio/sentry/x0;->b:Lio/sentry/h;

    iget-object v6, v6, Lio/sentry/x0;->a:LA9/b;
    ...
    iget-wide v10, v7, Lio/sentry/h;->a:J
    ...
    iget-wide v10, v7, Lio/sentry/h;->b:D
    ...
    iget-object p1, p0, Lio/sentry/android/core/s;->k:Ljava/util/HashMap;
    ...
    iget-object p0, p0, Lio/sentry/android/core/s;->k:Ljava/util/HashMap;
