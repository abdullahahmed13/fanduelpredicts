...
.field public final h:Lio/sentry/android/core/E;
...
# direct methods
.method public constructor <init>(Lio/sentry/ILogger;Lio/sentry/android/core/E;)V
    .locals 4
    ...
    iput-boolean v0, p0, Lio/sentry/android/core/j;->i:Z
    ...
    iput-object v0, p0, Lio/sentry/android/core/j;->j:Ljava/util/regex/Pattern;

    const-string v0, "Logger is required."

    invoke-static {p1, v0}, Lorg/slf4j/helpers/c;->N(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object p1, p0, Lio/sentry/android/core/j;->g:Lio/sentry/ILogger;
    ...
    iput-object p2, p0, Lio/sentry/android/core/j;->h:Lio/sentry/android/core/E;
...
.method public final a()V
    ...
    iget-object v0, p0, Lio/sentry/android/core/j;->h:Lio/sentry/android/core/E;
    ...
    invoke-virtual {p0}, Lio/sentry/android/core/j;->c()J
...
.method public final b(Lio/sentry/x0;)V
    .locals 7
    ...
    iget-boolean v0, p0, Lio/sentry/android/core/j;->i:Z
    ...
    iget-wide v5, p0, Lio/sentry/android/core/j;->d:J
    ...
    iput-object v2, p1, Lio/sentry/x0;->b:Lio/sentry/h;
...
.method public final c()J
    ...
    iget-object v0, p0, Lio/sentry/android/core/j;->g:Lio/sentry/ILogger;

    :try_start_0
    iget-object v1, p0, Lio/sentry/android/core/j;->f:Ljava/io/File;

    invoke-static {v1}, Lio/sentry/util/b;->c(Ljava/io/File;)Ljava/lang/String;
    ...
    iput-boolean v2, p0, Lio/sentry/android/core/j;->i:Z
    ...
    iget-object v4, p0, Lio/sentry/android/core/j;->j:Ljava/util/regex/Pattern;
    ...
    invoke-interface {v0, v1, v4, p0}, Lio/sentry/ILogger;->b(Lio/sentry/SentryLevel;Ljava/lang/String;Ljava/lang/Throwable;)V
