...
.field private debugImagesLoader:Lio/sentry/android/core/O;
...
.field private frameMetricsCollector:Lio/sentry/android/core/internal/util/i;
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    sget-object v4, Lio/sentry/android/core/X;->a:Lio/sentry/android/core/X;

    iput-object v4, p0, Lio/sentry/android/core/SentryAndroidOptions;->debugImagesLoader:Lio/sentry/android/core/O;
    ...
    const-string v0, "sentry.java.android/7.22.6"
...
.method private createSdkVersion()Lio/sentry/protocol/p;
    ...
    invoke-virtual {v0, v1}, Lio/sentry/i1;->k(Ljava/lang/String;)V
...
.method public getDebugImagesLoader()Lio/sentry/android/core/O;
    .locals 0
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation

    iget-object p0, p0, Lio/sentry/android/core/SentryAndroidOptions;->debugImagesLoader:Lio/sentry/android/core/O;

    return-object p0
.end method

.method public getFrameMetricsCollector()Lio/sentry/android/core/internal/util/i;
    .locals 0
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation

    iget-object p0, p0, Lio/sentry/android/core/SentryAndroidOptions;->frameMetricsCollector:Lio/sentry/android/core/internal/util/i;
...
.method public setBeforeScreenshotCaptureCallback(Lio/sentry/android/core/d0;)V
    .locals 0
    .param p1    # Lio/sentry/android/core/d0;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
...
.method public setDebugImagesLoader(Lio/sentry/android/core/O;)V
    .locals 0
    .param p1    # Lio/sentry/android/core/O;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    :cond_0
    sget-object p1, Lio/sentry/android/core/X;->a:Lio/sentry/android/core/X;

    :goto_0
    iput-object p1, p0, Lio/sentry/android/core/SentryAndroidOptions;->debugImagesLoader:Lio/sentry/android/core/O;
...
.method public setFrameMetricsCollector(Lio/sentry/android/core/internal/util/i;)V
    .locals 0
    .param p1    # Lio/sentry/android/core/internal/util/i;
        .annotation build Lorg/jetbrains/annotations/Nullable;
        .end annotation
    .end param

    iput-object p1, p0, Lio/sentry/android/core/SentryAndroidOptions;->frameMetricsCollector:Lio/sentry/android/core/internal/util/i;
...
.method public setNativeHandlerStrategy(Lio/sentry/android/core/NdkHandlerStrategy;)V
    .locals 0
    .param p1    # Lio/sentry/android/core/NdkHandlerStrategy;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
