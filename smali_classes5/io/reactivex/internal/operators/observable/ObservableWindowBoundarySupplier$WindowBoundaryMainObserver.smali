...
# static fields
.field public static final a:Lio/reactivex/internal/operators/observable/a2;
...
.field final boundaryObserver:Ljava/util/concurrent/atomic/AtomicReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lio/reactivex/internal/operators/observable/a2;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Lio/reactivex/internal/operators/observable/a2;-><init>(Ljava/lang/Object;I)V

    sput-object v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->a:Lio/reactivex/internal/operators/observable/a2;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->b:Ljava/lang/Object;
...
.method public constructor <init>(Ldb/t;ILjava/util/concurrent/Callable;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:Ldb/t;
...
.method public final a()V
    ...
    sget-object v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->a:Lio/reactivex/internal/operators/observable/a2;
...
.method public final b()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:Ldb/t;
    ...
    iput-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->window:Lio/reactivex/subjects/g;

    return-void

    :cond_2
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->window:Lio/reactivex/subjects/g;
    ...
    invoke-virtual {v5, v1}, Lio/reactivex/subjects/g;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_a
    sget-object v7, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->b:Ljava/lang/Object;

    if-eq v8, v7, :cond_b

    invoke-virtual {v5, v8}, Lio/reactivex/subjects/g;->onNext(Ljava/lang/Object;)V
    ...
    invoke-direct {v7, v5, p0}, Lio/reactivex/subjects/g;-><init>(ILjava/lang/Runnable;)V

    iput-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->window:Lio/reactivex/subjects/g;
    ...
    invoke-static {v5, v8}, Ljb/k;->b(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast v5, Ldb/r;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    new-instance v8, Lio/reactivex/internal/operators/observable/a2;

    const/4 v9, 0x0

    invoke-direct {v8, p0, v9}, Lio/reactivex/internal/operators/observable/a2;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-interface {v5, v8}, Ldb/r;->subscribe(Ldb/t;)V
    ...
    invoke-static {v2, v5}, Lio/reactivex/internal/util/c;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
...
.method public final dispose()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->upstream:Lfb/b;
...
.method public final onSubscribe(Lfb/b;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->upstream:Lfb/b;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->upstream:Lfb/b;

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:Ldb/t;
