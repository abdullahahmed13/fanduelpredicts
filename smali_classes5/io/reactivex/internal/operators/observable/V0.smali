...
.method public constructor <init>(Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/V0;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final subscribe(Ldb/t;)V
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/observable/ObservablePublish$InnerDisposable;-><init>(Ldb/t;)V

    invoke-interface {p1, v0}, Ldb/t;->onSubscribe(Lfb/b;)V

    :goto_0
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/V0;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, p1}, Lio/reactivex/internal/operators/observable/U0;-><init>(Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    :goto_2
    iget-object v4, v3, Lio/reactivex/internal/operators/observable/U0;->b:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object p1, Lio/reactivex/internal/operators/observable/U0;->f:[Lio/reactivex/internal/operators/observable/ObservablePublish$InnerDisposable;
    ...
    invoke-virtual {v3, v0}, Lio/reactivex/internal/operators/observable/U0;->a(Lio/reactivex/internal/operators/observable/ObservablePublish$InnerDisposable;)V
