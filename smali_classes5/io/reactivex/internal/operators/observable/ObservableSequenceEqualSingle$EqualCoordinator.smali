...
.field final observers:[Lio/reactivex/internal/operators/observable/x1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lio/reactivex/internal/operators/observable/x1;"
        }
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Ldb/C;ILdb/r;Ldb/r;Lhb/d;)V
    .locals 0

    invoke-direct {p0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->downstream:Ldb/C;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->first:Ldb/r;

    iput-object p4, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->second:Ldb/r;

    iput-object p5, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->comparer:Lhb/d;

    const/4 p1, 0x2

    new-array p3, p1, [Lio/reactivex/internal/operators/observable/x1;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->observers:[Lio/reactivex/internal/operators/observable/x1;

    new-instance p4, Lio/reactivex/internal/operators/observable/x1;

    const/4 p5, 0x0

    invoke-direct {p4, p0, p5, p2}, Lio/reactivex/internal/operators/observable/x1;-><init>(Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;II)V
...
.method public final a()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->observers:[Lio/reactivex/internal/operators/observable/x1;

    const/4 v1, 0x0

    aget-object v2, v0, v1

    iget-object v3, v2, Lio/reactivex/internal/operators/observable/x1;->b:Lio/reactivex/internal/queue/b;

    const/4 v4, 0x1

    aget-object v0, v0, v4

    iget-object v5, v0, Lio/reactivex/internal/operators/observable/x1;->b:Lio/reactivex/internal/queue/b;
    ...
    :cond_2
    iget-boolean v7, v2, Lio/reactivex/internal/operators/observable/x1;->d:Z

    if-eqz v7, :cond_3

    iget-object v8, v2, Lio/reactivex/internal/operators/observable/x1;->e:Ljava/lang/Throwable;
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->downstream:Ldb/C;

    invoke-interface {p0, v8}, Ldb/C;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_3
    iget-boolean v8, v0, Lio/reactivex/internal/operators/observable/x1;->d:Z

    if-eqz v8, :cond_4

    iget-object v9, v0, Lio/reactivex/internal/operators/observable/x1;->e:Ljava/lang/Throwable;
    ...
    invoke-interface {p0, v9}, Ldb/C;->onError(Ljava/lang/Throwable;)V
    ...
    :try_start_0
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->comparer:Lhb/d;
...
.method public final dispose()V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqualSingle$EqualCoordinator;->observers:[Lio/reactivex/internal/operators/observable/x1;

    const/4 v1, 0x0

    aget-object v1, p0, v1

    iget-object v1, v1, Lio/reactivex/internal/operators/observable/x1;->b:Lio/reactivex/internal/queue/b;

    invoke-virtual {v1}, Lio/reactivex/internal/queue/b;->clear()V

    aget-object p0, p0, v0

    iget-object p0, p0, Lio/reactivex/internal/operators/observable/x1;->b:Lio/reactivex/internal/queue/b;
