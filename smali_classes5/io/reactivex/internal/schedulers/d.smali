...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lio/reactivex/internal/schedulers/p;-><init>(Lio/reactivex/internal/schedulers/RxThreadFactory;)V
...
.method public constructor <init>()V
    ...
    iget-object p0, v1, Lio/reactivex/internal/schedulers/b;->b:[Lio/reactivex/internal/schedulers/c;
    ...
    invoke-virtual {v2}, Lio/reactivex/internal/schedulers/p;->dispose()V
...
.method public final b()Ldb/x$a;
    ...
    iget-object p0, p0, Lio/reactivex/internal/schedulers/d;->c:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {p0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lio/reactivex/internal/schedulers/b;

    invoke-virtual {p0}, Lio/reactivex/internal/schedulers/b;->a()Lio/reactivex/internal/schedulers/c;

    move-result-object p0

    invoke-direct {v0, p0}, Lio/reactivex/internal/schedulers/a;-><init>(Lio/reactivex/internal/schedulers/c;)V
...
.method public final d(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lfb/b;
    ...
    iget-object p0, p0, Lio/reactivex/internal/schedulers/p;->a:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final e(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lfb/b;
    ...
    iget-object v1, v1, Lio/reactivex/internal/schedulers/d;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object v7, Lio/reactivex/internal/disposables/EmptyDisposable;->a:Lio/reactivex/internal/disposables/EmptyDisposable;

    if-gtz v6, :cond_1

    new-instance v6, Lio/reactivex/internal/schedulers/j;

    iget-object v1, v1, Lio/reactivex/internal/schedulers/p;->a:Ljava/util/concurrent/ScheduledExecutorService;

    invoke-direct {v6, p1, v1}, Lio/reactivex/internal/schedulers/j;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lio/reactivex/internal/schedulers/j;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    new-instance v9, Lio/reactivex/internal/schedulers/ScheduledDirectPeriodicTask;

    invoke-direct {v9, p1}, Lio/reactivex/internal/schedulers/AbstractDirectTask;-><init>(Ljava/lang/Runnable;)V

    :try_start_1
    iget-object v0, v1, Lio/reactivex/internal/schedulers/p;->a:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-virtual {v9, v0}, Lio/reactivex/internal/schedulers/AbstractDirectTask;->a(Ljava/util/concurrent/Future;)V
    :try_end_1
