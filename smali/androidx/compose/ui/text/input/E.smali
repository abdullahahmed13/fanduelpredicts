...
.method public final a(Landroidx/compose/ui/text/input/i;)V
    ...
    invoke-static {v1, v2, v0}, LIb/p;->i(III)I
    ...
    invoke-static {p0, v2, v1}, LIb/p;->i(III)I

    move-result p0

    if-ge v0, p0, :cond_0

    invoke-virtual {p1, v0, p0}, Landroidx/compose/ui/text/input/i;->f(II)V

    goto :goto_0

    :cond_0
    invoke-virtual {p1, p0, v0}, Landroidx/compose/ui/text/input/i;->f(II)V
