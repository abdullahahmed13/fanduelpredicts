...
# instance fields
.field final synthetic $recomposer:Landroidx/compose/runtime/v0;

.field final synthetic $self:Landroidx/compose/ui/platform/i1;
...
# direct methods
.method public constructor <init>(Lkotlin/jvm/internal/Ref$ObjectRef;Landroidx/compose/runtime/v0;Landroidx/lifecycle/LifecycleOwner;Landroidx/compose/ui/platform/i1;Landroid/view/View;Lkotlin/coroutines/Continuation;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1;->$recomposer:Landroidx/compose/runtime/v0;
    ...
    iput-object p4, p0, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1;->$self:Landroidx/compose/ui/platform/i1;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v2, p0, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1;->$recomposer:Landroidx/compose/runtime/v0;
    ...
    iget-object v4, p0, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1;->$self:Landroidx/compose/ui/platform/i1;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1;-><init>(Lkotlin/jvm/internal/Ref$ObjectRef;Landroidx/compose/runtime/v0;Landroidx/lifecycle/LifecycleOwner;Landroidx/compose/ui/platform/i1;Landroid/view/View;Lkotlin/coroutines/Continuation;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4}, Landroidx/compose/ui/platform/k1;->a(Landroid/content/Context;)Lkotlinx/coroutines/flow/M;

    move-result-object v4

    invoke-interface {v4}, Lkotlinx/coroutines/flow/M;->getValue()Ljava/lang/Object;
    ...
    iget-object v6, v1, Landroidx/compose/ui/platform/v0;->a:Landroidx/compose/runtime/Z;

    check-cast v6, Landroidx/compose/runtime/I0;

    invoke-virtual {v6, v5}, Landroidx/compose/runtime/I0;->k(F)V
    ...
    invoke-direct {v5, v4, v1, v2}, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1$1$1;-><init>(Lkotlinx/coroutines/flow/M;Landroidx/compose/ui/platform/v0;Lkotlin/coroutines/Continuation;)V
    ...
    :goto_0
    :try_start_2
    iget-object v1, p0, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1;->$recomposer:Landroidx/compose/runtime/v0;
    ...
    invoke-virtual {v1, p0}, Landroidx/compose/runtime/v0;->E(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object p0, p0, Landroidx/compose/ui/platform/WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1;->$self:Landroidx/compose/ui/platform/i1;
