...
# instance fields
.field public final a:Landroidx/compose/runtime/V;
...
.method public constructor <init>(Landroidx/compose/runtime/V;)V
    ...
    iput-object p1, p0, Landroidx/compose/runtime/k0;->a:Landroidx/compose/runtime/V;

    new-instance p1, Landroidx/compose/runtime/Q;

    invoke-direct {p1}, Landroidx/compose/runtime/Q;-><init>()V

    iput-object p1, p0, Landroidx/compose/runtime/k0;->b:Landroidx/compose/runtime/Q;
...
.method public final K(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Landroidx/compose/runtime/PausableMonotonicFrameClock$withFrameNanos$1;-><init>(Landroidx/compose/runtime/k0;Lkotlin/coroutines/Continuation;)V
    ...
    iget-object p2, p0, Landroidx/compose/runtime/k0;->b:Landroidx/compose/runtime/Q;
    ...
    iget-object v2, p2, Landroidx/compose/runtime/Q;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-boolean v5, p2, Landroidx/compose/runtime/Q;->d:Z
    :try_end_0
    ...
    invoke-direct {v2, v4, v5}, Lkotlinx/coroutines/j;-><init>(ILkotlin/coroutines/Continuation;)V

    invoke-virtual {v2}, Lkotlinx/coroutines/j;->s()V

    iget-object v4, p2, Landroidx/compose/runtime/Q;->a:Ljava/lang/Object;

    monitor-enter v4

    :try_start_1
    iget-object v5, p2, Landroidx/compose/runtime/Q;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {v4, p2, v2}, Landroidx/compose/runtime/Latch$await$2$2;-><init>(Landroidx/compose/runtime/Q;Lkotlinx/coroutines/j;)V

    invoke-virtual {v2, v4}, Lkotlinx/coroutines/j;->u(Lkotlin/jvm/functions/Function1;)V
    ...
    :cond_7
    :goto_2
    iget-object p0, p0, Landroidx/compose/runtime/k0;->a:Landroidx/compose/runtime/V;
    ...
    invoke-interface {p0, p1, v0}, Landroidx/compose/runtime/V;->K(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
