...
# direct methods
.method public constructor <init>(Landroidx/compose/foundation/gestures/H;Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlin/jvm/internal/Ref$FloatRef;Landroidx/compose/foundation/gestures/Y;Lkotlin/jvm/internal/Ref$BooleanRef;)V
    .locals 0

    iput-object p1, p0, Landroidx/compose/foundation/gestures/MouseWheelScrollingLogic$dispatchMouseWheelScroll$3$1;->this$0:Landroidx/compose/foundation/gestures/H;
    ...
    iput-object p4, p0, Landroidx/compose/foundation/gestures/MouseWheelScrollingLogic$dispatchMouseWheelScroll$3$1;->$this_dispatchMouseWheelScroll:Landroidx/compose/foundation/gestures/Y;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroidx/compose/foundation/gestures/MouseWheelScrollingLogic$dispatchMouseWheelScroll$3$1;->this$0:Landroidx/compose/foundation/gestures/H;

    iget-object v0, v0, Landroidx/compose/foundation/gestures/H;->e:Lkotlinx/coroutines/channels/c;
    ...
    iget-object v2, p0, Landroidx/compose/foundation/gestures/MouseWheelScrollingLogic$dispatchMouseWheelScroll$3$1;->this$0:Landroidx/compose/foundation/gestures/H;

    invoke-virtual {v2, v0}, Landroidx/compose/foundation/gestures/H;->e(Landroidx/compose/foundation/gestures/G;)V
    ...
    invoke-virtual {v3, v0}, Landroidx/compose/foundation/gestures/G;->a(Landroidx/compose/foundation/gestures/G;)Landroidx/compose/foundation/gestures/G;
    ...
    iget-object v3, p0, Landroidx/compose/foundation/gestures/MouseWheelScrollingLogic$dispatchMouseWheelScroll$3$1;->$this_dispatchMouseWheelScroll:Landroidx/compose/foundation/gestures/Y;
    ...
    check-cast v4, Landroidx/compose/foundation/gestures/G;

    iget-wide v4, v4, Landroidx/compose/foundation/gestures/G;->a:J

    invoke-virtual {v3, v4, v5}, Landroidx/compose/foundation/gestures/Y;->e(J)J

    move-result-wide v4

    invoke-virtual {v3, v4, v5}, Landroidx/compose/foundation/gestures/Y;->g(J)F
    ...
    iget-object p0, p0, Landroidx/compose/foundation/gestures/MouseWheelScrollingLogic$dispatchMouseWheelScroll$3$1;->$targetValue:Lkotlin/jvm/internal/Ref$FloatRef;

    iget p0, p0, Lkotlin/jvm/internal/Ref$FloatRef;->element:F

    sub-float/2addr p0, p1

    invoke-static {p0}, Landroidx/compose/foundation/gestures/F;->a(F)Z
