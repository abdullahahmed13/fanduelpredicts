...
# static fields
.field private static final Companion:Landroidx/compose/foundation/gestures/d0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/compose/foundation/gestures/e0;->Companion:Landroidx/compose/foundation/gestures/d0;
    ...
    sput-object v0, Landroidx/compose/foundation/gestures/e0;->f:Landroidx/compose/animation/core/i;
...
.method public constructor <init>(Landroidx/compose/animation/core/T;)V
    ...
    sget-object v0, Landroidx/compose/animation/core/l0;->a:Landroidx/compose/animation/core/k0;

    invoke-virtual {p1, v0}, Landroidx/compose/animation/core/T;->a(Landroidx/compose/animation/core/j0;)Landroidx/compose/animation/core/m0;

    move-result-object p1

    iput-object p1, p0, Landroidx/compose/foundation/gestures/e0;->a:Landroidx/compose/animation/core/m0;

    const-wide/high16 v0, -0x8000000000000000L

    iput-wide v0, p0, Landroidx/compose/foundation/gestures/e0;->b:J

    sget-object p1, Landroidx/compose/foundation/gestures/e0;->f:Landroidx/compose/animation/core/i;

    iput-object p1, p0, Landroidx/compose/foundation/gestures/e0;->c:Landroidx/compose/animation/core/i;

    return-void
.end method

.method public static final synthetic a()Landroidx/compose/foundation/gestures/d0;
    .locals 1

    sget-object v0, Landroidx/compose/foundation/gestures/e0;->Companion:Landroidx/compose/foundation/gestures/d0;
...
# virtual methods
.method public final b(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Lkotlin/coroutines/jvm/internal/ContinuationImpl;)Ljava/lang/Object;
    .locals 12
    ...
    invoke-direct {v0, p0, p3}, Landroidx/compose/foundation/gestures/UpdatableAnimationState$animateToZero$1;-><init>(Landroidx/compose/foundation/gestures/e0;Lkotlin/coroutines/jvm/internal/ContinuationImpl;)V
    ...
    sget-object v3, Landroidx/compose/foundation/gestures/e0;->f:Landroidx/compose/animation/core/i;
    ...
    check-cast v2, Landroidx/compose/foundation/gestures/e0;
    ...
    iget-boolean p3, p0, Landroidx/compose/foundation/gestures/e0;->d:Z
    ...
    sget-object v2, Landroidx/compose/ui/r;->a:Landroidx/compose/ui/r;
    ...
    invoke-interface {p3}, Landroidx/compose/ui/s;->E()F
    ...
    :goto_1
    iput-boolean v9, p0, Landroidx/compose/foundation/gestures/e0;->d:Z

    :cond_6
    :try_start_2
    sget-object v2, Landroidx/compose/foundation/gestures/e0;->Companion:Landroidx/compose/foundation/gestures/d0;

    iget v10, p0, Landroidx/compose/foundation/gestures/e0;->e:F
    ...
    invoke-direct {v2, p0, p3, p1}, Landroidx/compose/foundation/gestures/UpdatableAnimationState$animateToZero$4;-><init>(Landroidx/compose/foundation/gestures/e0;FLkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {v10}, Landroidx/compose/runtime/b;->s(Lkotlin/coroutines/CoroutineContext;)Landroidx/compose/runtime/V;

    move-result-object v10

    invoke-interface {v10, v2, v0}, Landroidx/compose/runtime/V;->K(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_4
    :try_start_3
    iget p3, p1, Landroidx/compose/foundation/gestures/e0;->e:F
    ...
    invoke-direct {p3, p1, p2}, Landroidx/compose/foundation/gestures/UpdatableAnimationState$animateToZero$5;-><init>(Landroidx/compose/foundation/gestures/e0;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {p2}, Landroidx/compose/runtime/b;->s(Lkotlin/coroutines/CoroutineContext;)Landroidx/compose/runtime/V;

    move-result-object p2

    invoke-interface {p2, p3, v0}, Landroidx/compose/runtime/V;->K(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_6
    iput-wide v4, p1, Landroidx/compose/foundation/gestures/e0;->b:J

    iput-object v3, p1, Landroidx/compose/foundation/gestures/e0;->c:Landroidx/compose/animation/core/i;

    iput-boolean v8, p1, Landroidx/compose/foundation/gestures/e0;->d:Z
