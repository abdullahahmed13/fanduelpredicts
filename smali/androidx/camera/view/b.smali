...
.method public final a(ILandroid/graphics/Rect;Landroid/util/Size;)Landroid/graphics/Matrix;
    ...
    iget-object v2, p0, Landroidx/camera/view/b;->d:Landroid/graphics/Matrix;

    invoke-direct {v1, v2}, Landroid/graphics/Matrix;-><init>(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, p3, p1}, Landroidx/camera/view/b;->c(Landroid/util/Size;I)Landroid/graphics/Matrix;
...
.method public final b()Landroid/util/Size;
    ...
    iget-object p0, p0, Landroidx/camera/view/b;->b:Landroid/graphics/Rect;
...
.method public final c(Landroid/util/Size;I)Landroid/graphics/Matrix;
    ...
    invoke-static {p1, v1, v0}, LL/k;->d(Landroid/util/Size;ZLandroid/util/Size;)Z
    ...
    invoke-static {v6, v5}, Lcom/fasterxml/uuid/a;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    sget-object v6, Landroidx/camera/view/PreviewView$ScaleType;->c:Landroidx/camera/view/PreviewView$ScaleType;

    if-eq v3, v6, :cond_5

    sget-object v6, Landroidx/camera/view/PreviewView$ScaleType;->b:Landroidx/camera/view/PreviewView$ScaleType;

    if-eq v3, v6, :cond_5

    sget-object v6, Landroidx/camera/view/PreviewView$ScaleType;->d:Landroidx/camera/view/PreviewView$ScaleType;
    ...
    invoke-static {v0, v1, p1, p2}, LL/k;->a(IZLandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public final d()Landroid/graphics/Matrix;
    ...
    iget p0, p0, Landroidx/camera/view/b;->c:I

    goto :goto_0

    :cond_0
    iget p0, p0, Landroidx/camera/view/b;->e:I

    invoke-static {p0}, Lpd/a;->c0(I)I
    ...
    invoke-static {p0, v1, v0, v0}, LL/k;->a(IZLandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/Matrix;
...
.method public final e(Landroid/util/Size;I)Landroid/graphics/RectF;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/camera/view/b;->c(Landroid/util/Size;I)Landroid/graphics/Matrix;
