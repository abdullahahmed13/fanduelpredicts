...
.method public final apply(Landroidx/core/app/i;)V
    ...
    check-cast v2, Landroidx/core/app/I;

    iget-object v2, v2, Landroidx/core/app/I;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, v0, Landroidx/core/app/B;->mBigContentTitle:Ljava/lang/CharSequence;
    ...
    instance-of v7, v1, Landroidx/core/app/I;

    if-eqz v7, :cond_0

    move-object v7, v1

    check-cast v7, Landroidx/core/app/I;

    iget-object v7, v7, Landroidx/core/app/I;->a:Landroid/content/Context;
    ...
    :goto_0
    invoke-virtual {v3, v7}, Landroidx/core/graphics/drawable/IconCompat;->d(Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    invoke-static {v2, v3}, Landroidx/core/app/o;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_8
    instance-of v4, v1, Landroidx/core/app/I;

    if-eqz v4, :cond_9

    check-cast v1, Landroidx/core/app/I;

    iget-object v1, v1, Landroidx/core/app/I;->a:Landroid/content/Context;
    ...
    :goto_3
    invoke-virtual {v3, v1}, Landroidx/core/graphics/drawable/IconCompat;->d(Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object v1

    invoke-static {v2, v1}, Landroidx/core/app/n;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_a
    :goto_4
    iget-boolean v1, v0, Landroidx/core/app/B;->mSummaryTextSet:Z

    if-eqz v1, :cond_b

    iget-object v0, v0, Landroidx/core/app/B;->mSummaryText:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v0}, Landroidx/core/app/o;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Landroidx/core/app/o;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
