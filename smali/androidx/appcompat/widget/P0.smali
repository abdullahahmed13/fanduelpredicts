...
.field public static final h:Landroidx/appcompat/widget/O0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/P0;->h:Landroidx/appcompat/widget/O0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/P0;->b:Ljava/util/WeakHashMap;
...
.method public static declared-synchronized e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :try_start_0
    sget-object v1, Landroidx/appcompat/widget/P0;->h:Landroidx/appcompat/widget/O0;
    ...
    invoke-virtual {v1, p0, v2}, Landroidx/collection/E;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/appcompat/widget/P0;->b:Ljava/util/WeakHashMap;
    ...
    :cond_2
    :try_start_2
    invoke-virtual {v3, v1, v2}, Landroidx/collection/C;->h(J)V
    :try_end_2
    ...
    :cond_4
    iget-object v3, p0, Landroidx/appcompat/widget/P0;->e:Lx/V;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/P0;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2}, Lx/V;->e(Landroidx/appcompat/widget/P0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/P0;->b:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, v1, v2, p1}, Landroidx/collection/C;->g(JLjava/lang/Object;)V
    :try_end_3
...
.method public final declared-synchronized c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, Landroidx/appcompat/widget/P0;->d(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public final declared-synchronized d(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-boolean v0, p0, Landroidx/appcompat/widget/P0;->d:Z
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/P0;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/P0;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/P0;->g(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public final declared-synchronized f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/appcompat/widget/P0;->a:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2}, Landroidx/collection/SparseArrayCompat;->e(I)Ljava/lang/Object;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/P0;->e:Lx/V;
    ...
    :cond_1
    invoke-virtual {v0, p1, p2}, Lx/V;->g(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/P0;->a:Ljava/util/WeakHashMap;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/P0;->a:Ljava/util/WeakHashMap;
...
.method public final g(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/P0;->f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/P0;->e:Lx/V;
    ...
    invoke-static {p1, v6}, Landroidx/appcompat/widget/n1;->c(Landroid/content/Context;I)I

    move-result p3

    sget-object v0, Landroidx/appcompat/widget/y;->b:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p2, p3, v0}, Lx/V;->h(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v5}, Landroidx/appcompat/widget/n1;->c(Landroid/content/Context;I)I

    move-result p1

    invoke-static {p0, p1, v0}, Lx/V;->h(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v6}, Landroidx/appcompat/widget/n1;->b(Landroid/content/Context;I)I
    ...
    sget-object v2, Landroidx/appcompat/widget/y;->b:Landroid/graphics/PorterDuff$Mode;

    iget-object v3, p0, Lx/V;->b:Ljava/lang/Object;

    check-cast v3, [I

    invoke-static {p2, v3}, Lx/V;->a(I[I)Z
    ...
    invoke-static {p0, v2}, Landroidx/appcompat/widget/y;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
