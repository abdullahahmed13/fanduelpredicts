...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;Z)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/B1;->h:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/B1;->h:Ljava/lang/CharSequence;
    ...
    :goto_0
    iput-boolean v1, p0, Landroidx/appcompat/widget/B1;->g:Z

    invoke-virtual {p1}, Landroidx/appcompat/widget/Toolbar;->getNavigationIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/B1;->f:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1, v5, v3, v4, v0}, Landroidx/appcompat/widget/r1;->f(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/r1;

    move-result-object v1

    const/16 v3, 0xf

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/r1;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    iput-object v4, p0, Landroidx/appcompat/widget/B1;->o:Landroid/graphics/drawable/Drawable;
    ...
    iput-boolean v2, p0, Landroidx/appcompat/widget/B1;->g:Z

    iput-object v3, p0, Landroidx/appcompat/widget/B1;->h:Ljava/lang/CharSequence;
    ...
    iget-boolean v4, p0, Landroidx/appcompat/widget/B1;->g:Z
    ...
    invoke-static {v2, v3}, Landroidx/core/view/W;->l(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/B1;->i:Ljava/lang/CharSequence;

    iget v3, p0, Landroidx/appcompat/widget/B1;->b:I
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/B1;->e:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/B1;->d:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroidx/appcompat/widget/B1;->c()V

    :cond_4
    iget-object v2, p0, Landroidx/appcompat/widget/B1;->f:Landroid/graphics/drawable/Drawable;

    if-nez v2, :cond_6

    iget-object v2, p0, Landroidx/appcompat/widget/B1;->o:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_6

    iput-object v2, p0, Landroidx/appcompat/widget/B1;->f:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/widget/B1;->a(I)V
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/B1;->c:Landroid/view/View;

    if-eqz v3, :cond_7

    iget v4, p0, Landroidx/appcompat/widget/B1;->b:I
    ...
    :cond_7
    iput-object v2, p0, Landroidx/appcompat/widget/B1;->c:Landroid/view/View;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/B1;->o:Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    iput v3, p0, Landroidx/appcompat/widget/B1;->b:I
    ...
    :goto_4
    iput-object v5, p0, Landroidx/appcompat/widget/B1;->j:Ljava/lang/CharSequence;
    ...
    new-instance p2, Landroidx/appcompat/widget/z1;

    invoke-direct {p2, p0}, Landroidx/appcompat/widget/z1;-><init>(Landroidx/appcompat/widget/B1;)V
...
.method public final a(I)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/B1;->f:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/B1;->o:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/B1;->c:Landroid/view/View;
...
.method public final b()V
    ...
    iget p0, p0, Landroidx/appcompat/widget/B1;->n:I
    ...
    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/B1;->j:Ljava/lang/CharSequence;
...
.method public final c()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/B1;->d:Landroid/graphics/drawable/Drawable;
