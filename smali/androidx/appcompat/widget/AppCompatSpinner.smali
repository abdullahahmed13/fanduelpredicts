...
.field private mForwardingListener:Landroidx/appcompat/widget/z0;

.field private mPopup:Landroidx/appcompat/widget/W;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v0}, Landroidx/appcompat/widget/n1;->a(Landroid/view/View;Landroid/content/Context;)V

    .line 6
    sget-object v0, Lk/a;->w:[I
    ...
    invoke-direct {v3, p0}, Landroidx/appcompat/widget/s;-><init>(Landroid/view/View;)V

    iput-object v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mBackgroundTintHelper:Landroidx/appcompat/widget/s;

    const/4 v3, 0x4

    .line 8
    iget-object v4, v2, Landroidx/appcompat/widget/r1;->b:Landroid/content/res/TypedArray;
    ...
    invoke-direct {v5, p1, v3}, Lp/d;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v3, p0, v8, p2, p3}, Landroidx/appcompat/widget/U;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 17
    iget-object v8, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;

    invoke-static {v8, p2, v0, p3, v1}, Landroidx/appcompat/widget/r1;->f(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/r1;

    move-result-object v0

    .line 18
    iget-object v8, v0, Landroidx/appcompat/widget/r1;->b:Landroid/content/res/TypedArray;
    ...
    .line 20
    invoke-virtual {v0, v7}, Landroidx/appcompat/widget/r1;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    .line 21
    invoke-virtual {v3, v8}, Landroidx/appcompat/widget/I0;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 23
    iput-object v6, v3, Landroidx/appcompat/widget/U;->A:Ljava/lang/CharSequence;

    .line 24
    invoke-virtual {v0}, Landroidx/appcompat/widget/r1;->g()V

    .line 25
    iput-object v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/W;

    .line 26
    new-instance v0, Landroidx/appcompat/widget/M;

    invoke-direct {v0, p0, p0, v3}, Landroidx/appcompat/widget/M;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroidx/appcompat/widget/AppCompatSpinner;Landroidx/appcompat/widget/U;)V

    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mForwardingListener:Landroidx/appcompat/widget/z0;
    ...
    invoke-direct {v0, p0}, Landroidx/appcompat/widget/P;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;)V

    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/W;
    ...
    .line 29
    iput-object v3, v0, Landroidx/appcompat/widget/P;->c:Ljava/lang/CharSequence;
    ...
    .line 34
    :cond_5
    invoke-virtual {v2}, Landroidx/appcompat/widget/r1;->g()V
    ...
    .line 39
    :cond_6
    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mBackgroundTintHelper:Landroidx/appcompat/widget/s;

    invoke-virtual {p0, p2, p3}, Landroidx/appcompat/widget/s;->d(Landroid/util/AttributeSet;I)V
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/W;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Landroidx/appcompat/widget/W;->b()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/W;->j()I
...
.method public final getInternalPopup()Landroidx/appcompat/widget/W;
    .locals 0

    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/W;
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/W;->e()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/W;->getHintText()Ljava/lang/CharSequence;
...
.method public onDetachedFromWindow()V
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/W;->dismiss()V
...
.method public onMeasure(II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/W;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {v0, p0, v1}, Landroidx/appcompat/widget/N;-><init>(Ljava/lang/Object;I)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/W;->a()Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mForwardingListener:Landroidx/appcompat/widget/z0;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 9
    iput-object p1, v1, Landroidx/appcompat/widget/Q;->a:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v2, v1, Landroidx/appcompat/widget/Q;->b:Landroid/widget/ListAdapter;
    ...
    .line 14
    invoke-static {p1, v0}, Landroidx/appcompat/widget/O;->a(Landroid/widget/ThemedSpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    .line 15
    :cond_3
    invoke-interface {p0, v1}, Landroidx/appcompat/widget/W;->l(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/W;->h(I)V

    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->mPopup:Landroidx/appcompat/widget/W;

    invoke-interface {p0, p1}, Landroidx/appcompat/widget/W;->d(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/W;->g(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/W;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/W;->f(Ljava/lang/CharSequence;)V
...
.method public showPopup()V
    ...
    invoke-interface {v0, v1, p0}, Landroidx/appcompat/widget/W;->i(II)V
