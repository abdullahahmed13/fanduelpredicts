...
.field private mEmojiCompatInitCallback:Landroidx/appcompat/widget/m1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v3}, Landroidx/appcompat/widget/n1;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    invoke-static {p1, p2, v7, p3, v1}, Landroidx/appcompat/widget/r1;->f(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/r1;
    ...
    .line 21
    iget-object v9, v3, Landroidx/appcompat/widget/r1;->b:Landroid/content/res/TypedArray;
    ...
    invoke-static/range {v5 .. v11}, Landroidx/core/view/T;->b(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    const/4 v4, 0x2

    .line 22
    invoke-virtual {v3, v4}, Landroidx/appcompat/widget/r1;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 26
    :cond_1
    iget-object v4, v3, Landroidx/appcompat/widget/r1;->b:Landroid/content/res/TypedArray;
    ...
    .line 40
    invoke-virtual {v3, v5}, Landroidx/appcompat/widget/r1;->a(I)Landroid/content/res/ColorStateList;
    ...
    .line 44
    invoke-static {v5, v0}, Landroidx/appcompat/widget/p0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Landroidx/appcompat/widget/c0;

    .line 63
    invoke-virtual {v0, p2, p3}, Landroidx/appcompat/widget/c0;->f(Landroid/util/AttributeSet;I)V
    ...
    .line 68
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Landroidx/appcompat/widget/B;

    move-result-object p1

    .line 69
    invoke-virtual {p1, p2, p3}, Landroidx/appcompat/widget/B;->c(Landroid/util/AttributeSet;I)V
...
.method private getEmojiTextViewHelper()Landroidx/appcompat/widget/B;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/B;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/B;

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/B;
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/p0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Landroidx/appcompat/widget/p0;->c:Landroid/graphics/Rect;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/B;->b:Li3/c;

    iget-object v0, v0, Li3/c;->b:Ljava/lang/Object;

    check-cast v0, Lcoil3/network/j;

    invoke-virtual {v0, v1}, Lcoil3/network/j;->b0(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final c()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mEmojiCompatInitCallback:Landroidx/appcompat/widget/m1;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/B;

    invoke-virtual {v0}, Landroidx/appcompat/widget/B;->b()Z
    ...
    invoke-direct {v1, p0}, Landroidx/appcompat/widget/m1;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->mEmojiCompatInitCallback:Landroidx/appcompat/widget/m1;

    invoke-virtual {v0, v1}, LF1/i;->h(LF1/f;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Landroidx/appcompat/widget/p0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Landroidx/appcompat/widget/p0;->c:Landroid/graphics/Rect;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Landroidx/appcompat/widget/p0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/p0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public setChecked(Z)V
    ...
    new-instance v8, Landroidx/core/view/J;

    const/4 v6, 0x1

    move-object v1, v8

    invoke-direct/range {v1 .. v6}, Landroidx/core/view/J;-><init>(ILjava/lang/Class;III)V

    invoke-virtual {v8, p0, v7}, LG1/c;->f(Landroid/view/View;Ljava/lang/Object;)V
...
.method public setEmojiCompatEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/B;->e(Z)V
...
.method public setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    invoke-static {p1, v1}, Lh1/a;->getColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p1, Lo/a;->a:Ljava/util/Locale;
    ...
    :cond_6
    iput-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->mSwitchTransformationMethod:Landroid/text/method/TransformationMethod;
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    new-instance v6, Landroidx/core/view/J;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/core/view/J;-><init>(ILjava/lang/Class;III)V

    invoke-virtual {v6, p0, p1}, LG1/c;->f(Landroid/view/View;Ljava/lang/Object;)V
