...
.field public final g:Landroidx/vectordrawable/graphics/drawable/l;
...
.method public constructor <init>()V
    ...
    .line 12
    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/o;->o:Landroidx/collection/f;
...
.method public constructor <init>(Landroidx/vectordrawable/graphics/drawable/o;)V
    ...
    invoke-direct {v1, v2, v0}, Landroidx/vectordrawable/graphics/drawable/l;-><init>(Landroidx/vectordrawable/graphics/drawable/l;Landroidx/collection/f;)V
    ...
    .line 38
    invoke-virtual {v0, v1, p0}, Landroidx/collection/l0;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
# virtual methods
.method public final a(Landroidx/vectordrawable/graphics/drawable/l;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    .locals 18
    ...
    iget-object v10, v7, Landroidx/vectordrawable/graphics/drawable/l;->a:Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/vectordrawable/graphics/drawable/o;->a(Landroidx/vectordrawable/graphics/drawable/l;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    ...
    iget-object v3, v6, Landroidx/vectordrawable/graphics/drawable/o;->a:Landroid/graphics/Path;

    invoke-virtual {v3}, Landroid/graphics/Path;->reset()V

    iget-object v4, v0, Landroidx/vectordrawable/graphics/drawable/n;->a:[Lj1/f;

    if-eqz v4, :cond_3

    invoke-static {v4, v3}, Lj1/g;->m([Lj1/f;Landroid/graphics/Path;)V

    :cond_3
    iget-object v4, v6, Landroidx/vectordrawable/graphics/drawable/o;->b:Landroid/graphics/Path;

    invoke-virtual {v4}, Landroid/graphics/Path;->reset()V

    instance-of v5, v0, Landroidx/vectordrawable/graphics/drawable/j;
    ...
    iget v5, v0, Landroidx/vectordrawable/graphics/drawable/k;->i:F
    ...
    iget v9, v0, Landroidx/vectordrawable/graphics/drawable/k;->j:F
    ...
    :goto_3
    iget v9, v0, Landroidx/vectordrawable/graphics/drawable/k;->k:F

    add-float/2addr v5, v9

    rem-float/2addr v5, v10

    iget v14, v0, Landroidx/vectordrawable/graphics/drawable/k;->j:F

    add-float/2addr v14, v9

    rem-float/2addr v14, v10

    iget-object v9, v6, Landroidx/vectordrawable/graphics/drawable/o;->f:Landroid/graphics/PathMeasure;
    ...
    iput-object v9, v6, Landroidx/vectordrawable/graphics/drawable/o;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v10, v6, Landroidx/vectordrawable/graphics/drawable/o;->f:Landroid/graphics/PathMeasure;

    const/4 v15, 0x1

    invoke-virtual {v10, v5, v9, v3, v15}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object v5, v6, Landroidx/vectordrawable/graphics/drawable/o;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v3, v0, Landroidx/vectordrawable/graphics/drawable/k;->f:Landroidx/compose/foundation/lazy/layout/V;

    iget-object v5, v3, Landroidx/compose/foundation/lazy/layout/V;->b:Ljava/lang/Object;
    ...
    :cond_a
    iget v5, v3, Landroidx/compose/foundation/lazy/layout/V;->a:I
    ...
    iget-object v5, v6, Landroidx/vectordrawable/graphics/drawable/o;->e:Landroid/graphics/Paint;
    ...
    iput-object v5, v6, Landroidx/vectordrawable/graphics/drawable/o;->e:Landroid/graphics/Paint;
    ...
    iget-object v11, v3, Landroidx/compose/foundation/lazy/layout/V;->b:Ljava/lang/Object;
    ...
    iget v3, v0, Landroidx/vectordrawable/graphics/drawable/k;->h:F
    ...
    iget v3, v3, Landroidx/compose/foundation/lazy/layout/V;->a:I

    iget v11, v0, Landroidx/vectordrawable/graphics/drawable/k;->h:F

    sget-object v16, Landroidx/vectordrawable/graphics/drawable/r;->j:Landroid/graphics/PorterDuff$Mode;
    ...
    iget v3, v0, Landroidx/vectordrawable/graphics/drawable/n;->c:I
    ...
    :cond_f
    iget-object v3, v0, Landroidx/vectordrawable/graphics/drawable/k;->d:Landroidx/compose/foundation/lazy/layout/V;
    ...
    :goto_9
    iget-object v5, v6, Landroidx/vectordrawable/graphics/drawable/o;->d:Landroid/graphics/Paint;
    ...
    iput-object v5, v6, Landroidx/vectordrawable/graphics/drawable/o;->d:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, Landroidx/vectordrawable/graphics/drawable/k;->m:Landroid/graphics/Paint$Join;
    ...
    :cond_12
    iget-object v11, v0, Landroidx/vectordrawable/graphics/drawable/k;->l:Landroid/graphics/Paint$Cap;
    ...
    :cond_13
    iget v11, v0, Landroidx/vectordrawable/graphics/drawable/k;->n:F
    ...
    iget v3, v0, Landroidx/vectordrawable/graphics/drawable/k;->g:F
    ...
    iget v11, v0, Landroidx/vectordrawable/graphics/drawable/k;->g:F
    ...
    iget v0, v0, Landroidx/vectordrawable/graphics/drawable/k;->e:F
...
.method public getRootAlpha()I
    ...
    iget p0, p0, Landroidx/vectordrawable/graphics/drawable/o;->l:I
