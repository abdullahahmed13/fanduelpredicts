...
.method public final c(IILandroid/view/animation/Interpolator;I)V
    ...
    :cond_4
    iget-object p4, p0, Landroidx/recyclerview/widget/J0;->d:Landroid/view/animation/Interpolator;

    if-eq p4, p3, :cond_5

    iput-object p3, p0, Landroidx/recyclerview/widget/J0;->d:Landroid/view/animation/Interpolator;
    ...
    iput-object p4, p0, Landroidx/recyclerview/widget/J0;->c:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->mLayout:Landroidx/recyclerview/widget/s0;
    ...
    :cond_2
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->mAdapter:Landroidx/recyclerview/widget/e0;
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->mLayout:Landroidx/recyclerview/widget/s0;

    iget-object v3, v3, Landroidx/recyclerview/widget/s0;->mSmoothScroller:Landroidx/recyclerview/widget/F0;

    if-eqz v3, :cond_5

    invoke-virtual {v3}, Landroidx/recyclerview/widget/F0;->isPendingInitialRun()Z

    move-result v4

    if-nez v4, :cond_5

    invoke-virtual {v3}, Landroidx/recyclerview/widget/F0;->isRunning()Z

    move-result v4

    if-eqz v4, :cond_5

    iget-object v4, v9, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/G0;
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/F0;->stop()V

    goto :goto_0

    :cond_3
    invoke-virtual {v3}, Landroidx/recyclerview/widget/F0;->getTargetPosition()I
    ...
    invoke-virtual {v3, v4}, Landroidx/recyclerview/widget/F0;->setTargetPosition(I)V

    invoke-virtual {v3, v2, v1}, Landroidx/recyclerview/widget/F0;->onAnimation(II)V
    ...
    :goto_5
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView;->mLayout:Landroidx/recyclerview/widget/s0;

    iget-object v2, v2, Landroidx/recyclerview/widget/s0;->mSmoothScroller:Landroidx/recyclerview/widget/F0;

    if-eqz v2, :cond_10

    invoke-virtual {v2}, Landroidx/recyclerview/widget/F0;->isPendingInitialRun()Z
    ...
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/recyclerview/widget/E;

    iget-object v2, v1, Landroidx/recyclerview/widget/E;->c:[I
    ...
    :cond_16
    iput v10, v1, Landroidx/recyclerview/widget/E;->d:I
    ...
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->mGapWorker:Landroidx/recyclerview/widget/G;

    if-eqz v1, :cond_18

    invoke-virtual {v1, v9, v15, v14}, Landroidx/recyclerview/widget/G;->a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    invoke-static {v9, v1}, Landroidx/recyclerview/widget/h0;->a(Landroid/view/View;F)V

    :cond_19
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->mLayout:Landroidx/recyclerview/widget/s0;

    iget-object v1, v1, Landroidx/recyclerview/widget/s0;->mSmoothScroller:Landroidx/recyclerview/widget/F0;

    if-eqz v1, :cond_1a

    invoke-virtual {v1}, Landroidx/recyclerview/widget/F0;->isPendingInitialRun()Z

    move-result v2

    if-eqz v2, :cond_1a

    invoke-virtual {v1, v10, v10}, Landroidx/recyclerview/widget/F0;->onAnimation(II)V
