...
.method public constructor <init>(Li4/f;I)V
    ...
    iput-object p1, p0, Lc4/l;->a:Li4/f;
...
.method public final a(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    iput-object p3, p0, Lc4/l;->c:Ljava/net/HttpURLConnection;
    ...
    iget-object v2, p0, Lc4/l;->c:Ljava/net/HttpURLConnection;
    ...
    :cond_2
    iget-object p3, p0, Lc4/l;->c:Ljava/net/HttpURLConnection;

    iget v0, p0, Lc4/l;->b:I
    ...
    iput-object p3, p0, Lc4/l;->d:Ljava/io/InputStream;

    iget-boolean p3, p0, Lc4/l;->e:Z
    ...
    iget-object p1, p0, Lc4/l;->c:Ljava/net/HttpURLConnection;
    ...
    invoke-direct {p4, p1, p2, p3}, Ly4/c;-><init>(Ljava/io/InputStream;J)V

    iput-object p4, p0, Lc4/l;->d:Ljava/io/InputStream;
    ...
    iput-object p1, p0, Lc4/l;->d:Ljava/io/InputStream;

    :goto_2
    iget-object p0, p0, Lc4/l;->d:Ljava/io/InputStream;
    ...
    invoke-virtual {p0}, Lc4/l;->e()V

    add-int/2addr p2, v2

    invoke-virtual {p0, v0, p2, p1, p4}, Lc4/l;->a(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    invoke-static {p3, p1}, Ld0/k;->f(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lc4/l;->c:Ljava/net/HttpURLConnection;
...
.method public final e()V
    ...
    iget-object v0, p0, Lc4/l;->d:Ljava/io/InputStream;
    ...
    :catch_0
    :cond_0
    iget-object v0, p0, Lc4/l;->c:Ljava/net/HttpURLConnection;
    ...
    iput-object v0, p0, Lc4/l;->c:Ljava/net/HttpURLConnection;
...
.method public final i(Lcom/bumptech/glide/Priority;Lc4/d;)V
    ...
    iget-object p1, p0, Lc4/l;->a:Li4/f;
    ...
    :try_start_0
    invoke-virtual {p1}, Li4/f;->b()Ljava/net/URL;

    move-result-object v5

    iget-object p1, p1, Li4/f;->a:Li4/j;

    invoke-virtual {p1}, Li4/j;->b()Ljava/util/Map;
    ...
    invoke-virtual {p0, v5, v6, v7, p1}, Lc4/l;->a(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
