...
.method public constructor <init>(LE/C;LE/B;LE/B;)V
    ...
    iput-boolean v1, p0, LU/e;->f:Z

    new-instance v2, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v2, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v2, p0, LU/e;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v1, Ljava/util/LinkedHashMap;

    invoke-direct {v1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v1, p0, LU/e;->h:Ljava/util/LinkedHashMap;
    ...
    iput-object v1, p0, LU/e;->b:Landroid/os/HandlerThread;
    ...
    iput-object v2, p0, LU/e;->d:Landroid/os/Handler;

    new-instance v1, LM/e;

    invoke-direct {v1, v2}, LM/e;-><init>(Landroid/os/Handler;)V

    iput-object v1, p0, LU/e;->c:LM/e;

    new-instance v1, LU/c;

    invoke-direct {v1, p2, p3}, LU/c;-><init>(LE/B;LE/B;)V

    iput-object v1, p0, LU/e;->a:LU/c;
    ...
    invoke-direct {p2, p0, p3, p1, v0}, LA3/q;-><init>(Ljava/lang/Object;ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, LU/e;->release()V
...
.method public final a(LE/D0;)V
    ...
    iget-object v0, p0, LU/e;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, v0, v1}, LU/e;->d(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public final c()V
    ...
    iget-object p0, p0, LU/e;->b:Landroid/os/HandlerThread;
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    :cond_0
    iget-object v0, p0, LU/e;->i:Landroid/graphics/SurfaceTexture;

    if-eqz v0, :cond_3

    iget-object v1, p0, LU/e;->j:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v0, p0, LU/e;->j:Landroid/graphics/SurfaceTexture;
    ...
    :try_start_0
    iget-object v3, p0, LU/e;->a:LU/c;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v4

    iget-object v8, p0, LU/e;->i:Landroid/graphics/SurfaceTexture;

    iget-object v9, p0, LU/e;->j:Landroid/graphics/SurfaceTexture;

    invoke-virtual/range {v3 .. v9}, LU/c;->q(JLandroid/view/Surface;LT/l;Landroid/graphics/SurfaceTexture;Landroid/graphics/SurfaceTexture;)V
    :try_end_0
