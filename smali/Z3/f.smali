...
.method public constructor <init>(Ljava/io/FileInputStream;Ljava/nio/charset/Charset;)V
    ...
    sget-object v0, LZ3/g;->a:Ljava/nio/charset/Charset;
    ...
    iput-object p1, p0, LZ3/f;->a:Ljava/io/FileInputStream;

    iput-object p2, p0, LZ3/f;->b:Ljava/nio/charset/Charset;

    const/16 p1, 0x2000

    new-array p1, p1, [B

    iput-object p1, p0, LZ3/f;->c:[B
...
.method public final a()Ljava/lang/String;
    ...
    iget-object v0, p0, LZ3/f;->a:Ljava/io/FileInputStream;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, LZ3/f;->c:[B
    ...
    iget-object v3, p0, LZ3/f;->a:Ljava/io/FileInputStream;
    ...
    iget-object v2, p0, LZ3/f;->c:[B

    aget-byte v6, v2, v1

    if-ne v6, v3, :cond_3

    iget v3, p0, LZ3/f;->d:I
    ...
    iget-object v6, p0, LZ3/f;->b:Ljava/nio/charset/Charset;
    ...
    invoke-direct {v1, p0, v2}, LZ3/e;-><init>(LZ3/f;I)V
    ...
    iget v7, p0, LZ3/f;->e:I

    sub-int/2addr v7, v6

    invoke-virtual {v1, v2, v6, v7}, Ljava/io/ByteArrayOutputStream;->write([BII)V

    iput v5, p0, LZ3/f;->e:I

    iget-object v2, p0, LZ3/f;->c:[B

    array-length v6, v2

    iget-object v7, p0, LZ3/f;->a:Ljava/io/FileInputStream;
    ...
    :goto_3
    iget v6, p0, LZ3/f;->e:I

    if-eq v2, v6, :cond_5

    iget-object v6, p0, LZ3/f;->c:[B
...
.method public final close()V
    ...
    iput-object v1, p0, LZ3/f;->c:[B

    iget-object p0, p0, LZ3/f;->a:Ljava/io/FileInputStream;
