.class public final Lcom/fanduel/libs/location/enforcer/usecases/k;
...
.method public static k(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Lcom/fanduel/libs/location/enforcer/usecases/k;->m(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lcom/fanduel/libs/location/enforcer/usecases/k;->m(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static l([Lr1/g;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    iget-object v5, v4, Lr1/g;->a:Landroid/net/Uri;
    ...
    iget v7, v4, Lr1/g;->c:I

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setWeight(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget-boolean v7, v4, Lr1/g;->d:Z

    invoke-virtual {v6, v7}, Landroid/graphics/fonts/Font$Builder;->setSlant(I)Landroid/graphics/fonts/Font$Builder;

    move-result-object v6

    iget v4, v4, Lr1/g;->b:I
...
.method public h()Lcom/datadog/android/core/internal/system/j;
    .locals 0

    new-instance p0, Lcom/datadog/android/core/internal/system/j;

    invoke-direct {p0}, Lcom/datadog/android/core/internal/system/j;-><init>()V
...
.method public j(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v3, p0}, Lcom/fanduel/libs/location/enforcer/usecases/k;->l([Lr1/g;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {p1, p3}, Lcom/fanduel/libs/location/enforcer/usecases/k;->k(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public serialize(Ljava/lang/Object;)Ljava/lang/String;
    ...
    check-cast p1, Lcom/datadog/android/rum/internal/domain/event/g;

    const-string p0, "model"

    invoke-static {p1, p0}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    instance-of p0, p1, Lcom/datadog/android/rum/internal/domain/event/f;

    if-eqz p0, :cond_0

    check-cast p1, Lcom/datadog/android/rum/internal/domain/event/f;
    ...
    iget-object v1, p1, Lcom/datadog/android/rum/internal/domain/event/f;->a:Ljava/lang/String;

    invoke-virtual {p0, v0, v1}, Lcom/google/gson/JsonObject;->addProperty(Ljava/lang/String;Ljava/lang/String;)V

    iget-wide v0, p1, Lcom/datadog/android/rum/internal/domain/event/f;->b:J
    ...
    iget-object p1, p1, Lcom/datadog/android/rum/internal/domain/event/f;->c:Ljava/lang/Boolean;
    ...
    const-string p1, "model.toJson().toString()"
...
.method public write(Lcom/prove/sdk/core/LogLevel;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 3
    sget-object p1, Lcom/prove/sdk/core/LogLevel;->a:Lcom/prove/sdk/core/LogLevel;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/fanduel/libs/location/enforcer/usecases/k;->write(Lcom/prove/sdk/core/LogLevel;Ljava/lang/String;)V
