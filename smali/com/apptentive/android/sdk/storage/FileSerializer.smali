...
.method public deserialize(Ljava/io/File;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v0}, Lcom/apptentive/android/sdk/storage/OverrideSerialVersionUIDObjectInputStream;-><init>(Ljava/io/InputStream;)V
    :try_end_1
    ...
    :goto_0
    :try_start_3
    new-instance v1, Lcom/apptentive/android/sdk/storage/SerializerException;

    invoke-direct {v1, p0}, Lcom/apptentive/android/sdk/storage/SerializerException;-><init>(Ljava/lang/Throwable;)V
...
.method public serialize(Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v1}, Lt/n;-><init>(Ljava/io/File;)V
    ...
    .line 5
    invoke-virtual {v0, v1}, Lt/n;->f(Ljava/io/FileOutputStream;)V
    :try_end_1
    ...
    .line 6
    :goto_0
    invoke-virtual {v0, v1}, Lt/n;->e(Ljava/io/FileOutputStream;)V
