...
.method static constructor <clinit>()V
    ...
    sput-object v0, LH2/b;->Companion:LH2/a;
...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;Lcoil/size/Scale;IZZ)V
    ...
    iput-object p2, p0, LH2/b;->a:Lcoil/size/Scale;

    iput p3, p0, LH2/b;->b:I

    iput-boolean p4, p0, LH2/b;->c:Z

    iput-boolean p5, p0, LH2/b;->d:Z

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, LH2/b;->e:Ljava/util/ArrayList;
    ...
    :goto_0
    invoke-virtual {p0, p2, p4}, LH2/b;->a(Ljava/lang/Integer;Ljava/lang/Integer;)I

    move-result p4

    iput p4, p0, LH2/b;->f:I
    ...
    iput p4, p0, LH2/b;->g:I

    const/16 p4, 0xff

    iput p4, p0, LH2/b;->i:I

    iput-object p2, p0, LH2/b;->k:Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    iput-object p2, p0, LH2/b;->l:Landroid/graphics/drawable/Drawable;

    if-lez p3, :cond_5

    iget-object p1, p0, LH2/b;->k:Landroid/graphics/drawable/Drawable;
...
.method public final b()V
    ...
    iput v0, p0, LH2/b;->j:I

    const/4 v0, 0x0

    iput-object v0, p0, LH2/b;->k:Landroid/graphics/drawable/Drawable;

    iget-object v0, p0, LH2/b;->e:Ljava/util/ArrayList;
...
.method public final c(Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;)V
    ...
    iget-object p0, p0, LH2/b;->a:Lcoil/size/Scale;

    invoke-static {v0, v1, v2, v3, p0}, LJ6/a;->m(IIIILcoil/size/Scale;)D
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, LH2/b;->j:I

    if-nez v0, :cond_1

    iget-object v0, p0, LH2/b;->k:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_0

    iget p0, p0, LH2/b;->i:I
...
.method public final getColorFilter()Landroid/graphics/ColorFilter;
    ...
    iget-object v3, p0, LH2/b;->l:Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    :goto_0
    iget-object p0, p0, LH2/b;->k:Landroid/graphics/drawable/Drawable;
...
.method public final getOpacity()I
    ...
    iget-object p0, p0, LH2/b;->l:Landroid/graphics/drawable/Drawable;
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v0, p1}, LH2/b;->c(Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;)V

    :cond_0
    iget-object v0, p0, LH2/b;->l:Landroid/graphics/drawable/Drawable;
