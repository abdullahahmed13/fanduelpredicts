...
.method public constructor <init>(Landroidx/compose/ui/graphics/painter/a;Landroidx/compose/ui/graphics/painter/a;Landroidx/compose/ui/layout/j;IZZ)V
    ...
    iput-object p1, p0, Lcoil3/compose/internal/CrossfadePainter;->h:Landroidx/compose/ui/graphics/painter/a;

    iput-object p2, p0, Lcoil3/compose/internal/CrossfadePainter;->i:Landroidx/compose/ui/graphics/painter/a;

    iput-object p3, p0, Lcoil3/compose/internal/CrossfadePainter;->k:Landroidx/compose/ui/layout/j;

    iput p4, p0, Lcoil3/compose/internal/CrossfadePainter;->l:I

    iput-boolean p5, p0, Lcoil3/compose/internal/CrossfadePainter;->m:Z

    iput-boolean p6, p0, Lcoil3/compose/internal/CrossfadePainter;->n:Z
    ...
    iput-object p1, p0, Lcoil3/compose/internal/CrossfadePainter;->o:Landroidx/compose/runtime/a0;
    ...
    iput-object p1, p0, Lcoil3/compose/internal/CrossfadePainter;->r:Landroidx/compose/runtime/Z;
    ...
    iput-object p1, p0, Lcoil3/compose/internal/CrossfadePainter;->s:Landroidx/compose/runtime/b0;
...
.method public final a(LF0/f;Landroidx/compose/ui/graphics/painter/a;F)V
    ...
    :cond_4
    iget-object v6, p0, Lcoil3/compose/internal/CrossfadePainter;->k:Landroidx/compose/ui/layout/j;
    ...
    iget-object p0, p0, Lcoil3/compose/internal/CrossfadePainter;->s:Landroidx/compose/runtime/b0;
    ...
    invoke-virtual {p1, p2, p3, p2, p3}, Li3/b;->t(FFFF)V
...
.method public final applyAlpha(F)Z
    ...
    iget-object p0, p0, Lcoil3/compose/internal/CrossfadePainter;->r:Landroidx/compose/runtime/Z;
...
.method public final getIntrinsicSize-NH-jbRc()J
    ...
    iget-object v0, p0, Lcoil3/compose/internal/CrossfadePainter;->h:Landroidx/compose/ui/graphics/painter/a;
    ...
    :goto_0
    iget-object v0, p0, Lcoil3/compose/internal/CrossfadePainter;->i:Landroidx/compose/ui/graphics/painter/a;
    ...
    :cond_4
    iget-boolean p0, p0, Lcoil3/compose/internal/CrossfadePainter;->n:Z
...
.method public final onDraw(LF0/f;)V
    ...
    iget-boolean v0, p0, Lcoil3/compose/internal/CrossfadePainter;->q:Z

    iget-object v1, p0, Lcoil3/compose/internal/CrossfadePainter;->r:Landroidx/compose/runtime/Z;

    iget-object v2, p0, Lcoil3/compose/internal/CrossfadePainter;->i:Landroidx/compose/ui/graphics/painter/a;
    ...
    invoke-virtual {p0, p1, v2, v0}, Lcoil3/compose/internal/CrossfadePainter;->a(LF0/f;Landroidx/compose/ui/graphics/painter/a;F)V

    return-void

    :cond_0
    iget-object v0, p0, Lcoil3/compose/internal/CrossfadePainter;->p:LXc/k;

    if-eqz v0, :cond_1

    iget-wide v3, v0, LXc/k;->a:J
    ...
    invoke-direct {v0, v3, v4}, LXc/k;-><init>(J)V

    iput-object v0, p0, Lcoil3/compose/internal/CrossfadePainter;->p:LXc/k;
    ...
    invoke-static {v3, v4}, LXc/b;->d(J)J

    move-result-wide v3

    long-to-float v0, v3

    iget v3, p0, Lcoil3/compose/internal/CrossfadePainter;->l:I
    ...
    iget-boolean v3, p0, Lcoil3/compose/internal/CrossfadePainter;->m:Z
    ...
    :goto_2
    iput-boolean v0, p0, Lcoil3/compose/internal/CrossfadePainter;->q:Z

    iget-object v0, p0, Lcoil3/compose/internal/CrossfadePainter;->h:Landroidx/compose/ui/graphics/painter/a;

    invoke-virtual {p0, p1, v0, v1}, Lcoil3/compose/internal/CrossfadePainter;->a(LF0/f;Landroidx/compose/ui/graphics/painter/a;F)V

    invoke-virtual {p0, p1, v2, v5}, Lcoil3/compose/internal/CrossfadePainter;->a(LF0/f;Landroidx/compose/ui/graphics/painter/a;F)V

    iget-boolean p1, p0, Lcoil3/compose/internal/CrossfadePainter;->q:Z
    ...
    :cond_4
    iget-object p0, p0, Lcoil3/compose/internal/CrossfadePainter;->o:Landroidx/compose/runtime/a0;
