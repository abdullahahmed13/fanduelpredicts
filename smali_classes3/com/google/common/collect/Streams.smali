...
.method public static synthetic b(Ljava/util/stream/IntStream;)Ljava/util/stream/IntStream;
    .locals 0

    invoke-static {p0}, Lcom/google/common/collect/Streams;->lambda$concat$2(Ljava/util/stream/IntStream;)Ljava/util/stream/IntStream;
...
.method public static synthetic c(Ljava/util/stream/DoubleStream;)Ljava/util/stream/DoubleStream;
    .locals 0

    invoke-static {p0}, Lcom/google/common/collect/Streams;->lambda$concat$4(Ljava/util/stream/DoubleStream;)Ljava/util/stream/DoubleStream;
...
.method public static varargs concat([Ljava/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    invoke-direct {v1, v2}, Lcom/google/common/collect/y;-><init>(I)V
    ...
    invoke-direct {v1, p0, v2}, Lcom/google/common/collect/I;-><init>(Ljava/lang/Object;I)V
...
.method public static synthetic d(Ljava/util/stream/LongStream;)Ljava/util/stream/LongStream;
    .locals 0

    invoke-static {p0}, Lcom/google/common/collect/Streams;->lambda$concat$3(Ljava/util/stream/LongStream;)Ljava/util/stream/LongStream;
...
.method public static synthetic e(Ljava/util/function/BiConsumer;Lcom/google/common/collect/Streams$TemporaryPair;)V
    .locals 0
...
.method public static findLast(Ljava/util/stream/Stream;)Ljava/util/Optional;
    ...
    invoke-direct {v1, v0, v2}, Lcom/google/common/collect/K;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v0, v3}, Lcom/google/common/collect/K;-><init>(Ljava/lang/Object;I)V
...
.method public static forEachPair(Ljava/util/stream/Stream;Ljava/util/stream/Stream;Ljava/util/function/BiConsumer;)V
    ...
    invoke-direct {p1, p2, v0}, Lcom/google/common/collect/D;-><init>(Ljava/util/function/BiConsumer;I)V
...
.method private static synthetic lambda$forEachPair$5(Ljava/util/function/BiConsumer;Lcom/google/common/collect/Streams$TemporaryPair;)V
    .locals 1
...
.method public static mapWithIndex(Ljava/util/stream/DoubleStream;Lcom/google/common/collect/Streams$DoubleFunctionWithIndex;)Ljava/util/stream/Stream;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/I;-><init>(Ljava/lang/Object;I)V
...
.method public static zip(Ljava/util/stream/Stream;Ljava/util/stream/Stream;Ljava/util/function/BiFunction;)Ljava/util/stream/Stream;
    ...
    invoke-direct {p2, p1, v0}, Lcom/google/common/collect/I;-><init>(Ljava/lang/Object;I)V
