...
.method public showErrorDialogFragment(Landroid/app/Activity;ILi/c;Landroid/content/DialogInterface$OnCancelListener;)Z
    .locals 6
    .param p1    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v5, p0, p1, p2, p3}, Lcom/google/android/gms/common/zac;-><init>(Lcom/google/android/gms/common/GoogleApiAvailability;Landroid/app/Activity;ILi/c;)V
...
.method public final zad(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    :try_start_0
    instance-of p0, p1, Landroidx/fragment/app/K;
    :try_end_0
    ...
    invoke-virtual {p1, p0, p3}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroidx/fragment/app/h0;Ljava/lang/String;)V
...
.method public final zae(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {p3, p2, v0}, Ld0/k;->j(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v3, p1, v4}, Landroidx/core/app/s;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    const/4 v4, 0x1

    iput-boolean v4, v3, Landroidx/core/app/s;->n:Z

    const/16 v5, 0x10

    invoke-virtual {v3, v5, v4}, Landroidx/core/app/s;->f(IZ)V
    ...
    invoke-direct {p3}, Landroidx/core/app/B;-><init>()V
    ...
    invoke-virtual {v3, p3}, Landroidx/core/app/s;->g(Landroidx/core/app/B;)V
    ...
    iget-object v0, v3, Landroidx/core/app/s;->y:Landroid/app/Notification;

    iput p3, v0, Landroid/app/Notification;->icon:I

    iput v5, v3, Landroidx/core/app/s;->j:I
    ...
    invoke-virtual {v3, p3, v0, p4}, Landroidx/core/app/s;->a(ILjava/lang/String;Landroid/app/PendingIntent;)V

    goto :goto_0

    :cond_3
    iput-object p4, v3, Landroidx/core/app/s;->g:Landroid/app/PendingIntent;
    ...
    iput-object p3, v3, Landroidx/core/app/s;->f:Ljava/lang/CharSequence;
    ...
    sget p4, Lcom/google/android/gms/base/R$string;->common_google_play_services_notification_channel_name:I
    ...
    :cond_7
    :goto_1
    iput-object p0, v3, Landroidx/core/app/s;->v:Ljava/lang/String;

    :goto_2
    invoke-virtual {v3}, Landroidx/core/app/s;->b()Landroid/app/Notification;
