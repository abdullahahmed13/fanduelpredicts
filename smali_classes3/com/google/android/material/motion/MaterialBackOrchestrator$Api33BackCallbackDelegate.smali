...
.method public createOnBackInvokedCallback(Lcom/google/android/material/motion/MaterialBackHandler;)Landroid/window/OnBackInvokedCallback;
    ...
    new-instance p0, Landroidx/appcompat/widget/u1;

    const/4 v0, 0x1

    invoke-direct {p0, p1, v0}, Landroidx/appcompat/widget/u1;-><init>(Ljava/lang/Object;I)V
...
.method public startListeningForBackCallbacks(Lcom/google/android/material/motion/MaterialBackHandler;Landroid/view/View;Z)V
    ...
    :cond_0
    invoke-static {p2}, Lapptentive/com/android/feedback/messagecenter/view/custom/b;->l(Landroid/view/View;)Landroid/window/OnBackInvokedDispatcher;
    ...
    :goto_0
    invoke-static {p2, p0, p1}, Lapptentive/com/android/feedback/messagecenter/view/custom/b;->u(Landroid/window/OnBackInvokedDispatcher;ILandroid/window/OnBackInvokedCallback;)V
...
.method public stopListeningForBackCallbacks(Landroid/view/View;)V
    ...
    invoke-static {p1}, Lapptentive/com/android/feedback/messagecenter/view/custom/b;->l(Landroid/view/View;)Landroid/window/OnBackInvokedDispatcher;
    ...
    invoke-static {p1, v0}, Lapptentive/com/android/feedback/messagecenter/view/custom/b;->A(Landroid/window/OnBackInvokedDispatcher;Landroid/window/OnBackInvokedCallback;)V
