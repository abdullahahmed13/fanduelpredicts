...
.method private createCornerAnimator(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v0, p1, v1}, LZ2/v;-><init>(Ljava/lang/Object;I)V
...
.method private getRoundedCornerRadius(Landroid/view/WindowInsets;I)I
    ...
    invoke-static {p1, p2}, Landroidx/core/view/e;->l(Landroid/view/WindowInsets;I)Landroid/view/RoundedCorner;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p0}, Landroidx/core/view/e;->d(Landroid/view/RoundedCorner;)I
...
.method public startBackProgress(Landroidx/activity/b;Landroid/view/View;)V
    .locals 0
...
.method public updateBackProgress(Landroidx/activity/b;Landroid/view/View;F)V
    .locals 2
    .param p1    # Landroidx/activity/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 4
    :cond_1
    iget p2, p1, Landroidx/activity/b;->d:I
