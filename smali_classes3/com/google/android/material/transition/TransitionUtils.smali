...
.method public static maybeAddTransition(Landroidx/transition/o0;Landroidx/transition/g0;)V
    .locals 0
...
.method public static maybeApplyThemeDuration(Landroidx/transition/g0;Landroid/content/Context;I)Z
    .locals 4
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/transition/g0;->setDuration(J)Landroidx/transition/g0;
...
.method public static maybeApplyThemeInterpolator(Landroidx/transition/g0;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
...
.method public static maybeApplyThemePath(Landroidx/transition/g0;Landroid/content/Context;I)Z
    .locals 0

    if-eqz p2, :cond_0

    invoke-static {p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)Landroidx/transition/O;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Landroidx/transition/g0;->setPathMotion(Landroidx/transition/O;)V
...
.method public static maybeRemoveTransition(Landroidx/transition/o0;Landroidx/transition/g0;)V
    .locals 0
    .param p1    # Landroidx/transition/g0;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/o0;->i(Landroidx/transition/g0;)V

    :cond_0
    return-void
.end method

.method public static resolveThemePath(Landroid/content/Context;I)Landroidx/transition/O;
    .locals 3
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-static {p0}, Lj1/g;->e(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p0

    invoke-direct {p1, p0}, Landroidx/transition/P;-><init>(Landroid/graphics/Path;)V
